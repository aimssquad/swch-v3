...
class CompanyController extends Controller
{
    ...
    public function getCompanieslink()
    {try {
        if (!empty(Session::get('emp_email'))) {
            ...
            return view('company/employee-cretion-link', $data);
        } else {
            return redirect('/');
        }
    } catch (Exception $e) {
    ...
    public function getCompaniesrti()
    {try {
        if (!empty(Session::get('emp_email'))) {
            ...
            return view('company/employee-rti-link', $data);
        } else {
            return redirect('/');
        }
    } catch (Exception $e) {
    ...
    public function getCompaniesofficer()
    {try {
        if (!empty(Session::get('emp_email'))) {
            ...
            return view('company/employee-officer-link', $data);
        } else {
            return redirect('/');
        }
    } catch (Exception $e) {
    ...
    public function getCompaniesofficerlevel()
    {try {
        if (!empty(Session::get('emp_email'))) {
            ...
            return view('company/employee-level-link', $data);
        } else {
            return redirect('/');
        }
    } catch (Exception $e) {
