  ...
  @include('leave-approver.include.header')
		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('leave-approver/leave-request')}}">Leave Approval</a>
							</li> -->
     ...
     $Roledata = DB::table('registration')      
                  ...
                  ->where('email','=',$pemail) 
                  ->first();
 $job_details=DB::table('employee')->where('emp_code', '=', $LeaveApply[0]->employee_id )->where('emid', '=', $Roledata->reg )->orderBy('id', 'DESC')->first();
