<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="{{url('leaveapprovedashboard')}}" class="logo">
	...
	<li><a href="{{url('leaveapprovedashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Leave Approver Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19" style="margin-right: 20px;" ></a></i>
