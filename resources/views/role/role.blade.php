		...
		<div class="main-panel">
		    <div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('role/view-users-role')}}">Role Management</a>
							</li>
							<li class="separator">
							/
							</li>
							<li class="nav-item active">
								<a href="#">Add New User Role</a>
							</li>
						</ul>
					</div>
			<div class="content">
				<div class="page-inner">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="card-title"><i class="far fa-user"></i> Add User Role</h4>
                                 @if(Session::has('message'))										
	<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
	    @endif	
								</div>
								<div class="card-body">
									<form action="{{ url('role/user-role') }}" method="post" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">	
			
										<div class="row form-group">
											<div class="col-md-3"><label>Select Module</label>
                            ...
                            @endforeach
											...
											<div class="col-md-3">
												<label>Menu</label>												
												 ...
												 <select id="role_menus" name="menu_name[]"    multiple data-live-search="true" required>
											...
											<div class="col-md-3">
												...
												<select class="selectpicker" multiple data-live-search="true"   name="user_rights_name[]" required>
