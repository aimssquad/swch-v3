                     ...
                     <div class="col-md-12">
                        <div class="card custom-card">
                           <div class="card-header">
                              <h4 class="card-title"><i class="far fa-user"></i> Role Management <span><a data-toggle="tooltip" data-placement="bottom" title="Add New Role " href="{{url('role/user-role')}}"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td><a href='{{url("role/user-role/$role->id")}}'><i class="ti-pencil-alt"></i></a> 
                                             ...
                                             <img  style="width: 15px;" src="{{ asset('assets/img/delete.png')}}"></a>
                                          </td>
                                       </tr>
                                       @endforeach   
                                    </tbody>
