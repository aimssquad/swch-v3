						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Holiday List
<span>		<a href="{{ url('holiday/add-holiday') }}">Add New Holiday List</a></span>								</h4>
	@if(Session::has('message'))										
        ...
        <?php $i=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='{{url("holiday/add-holiday/$holiday->id")}}'><i class="fas fa-edit"></i></a>
                                            	<a href='{{url("holiday/holidaydelete/$holiday->id")}}' onclick="return confirm('Are you sure you want to delete this holiday?');"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        <?php $i++;?>
                                       <?php
										}
