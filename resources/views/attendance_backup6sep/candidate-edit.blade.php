				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('recruitment/candidate')}}">Candidate</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
                                      ...
                                      <div class="row form-group">
                                       <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-remarks" type="text" class="form-control input-border-bottom" value="<?php  if($job->remarks!=''){  echo $job->remarks; } ?>" required="" name="remarks"   style="margin-top: 24px;">
							   	    	 ...
							   	    	 <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-date" type="date" class="form-control input-border-bottom" required=""  value="<?php  if(!empty($job_details)){  echo $job_details->date; } ?>"  name="date"  style="margin-top: 24px;">
