						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"> Interview  Details</h4>
								</div>
								<div class="card-body">
								...
								<div class="row form-group">
								      ...
								      <div class="row form-group">	
                                       <div class="col-md-6">
										...
										<div class="row form-group">
											<div class="col-md-4">
											<div class=" form-group form-floating-label current-stage">		
											
											  <select id="inputFloatingLabel-recruitment" class="form-control input-border-bottom" required="" name="status"  style="margin-top: 10px;">
											    <option value="">Select</option>
												
												<option value="Final Interview"  <?php  if($job->status!=''){  if($job->status=='Final Interview'){ echo 'selected';} } ?> >Final Interview</option>
                                      ...
                                      <div class="row form-group">
                                       <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-remarks" type="text" class="form-control input-border-bottom" value="<?php  if($job->remarks!='') {  if($job->status=='Final Interview'  || $job->status=='Job Offered'){  echo $job->remarks;} } ?>" required="" name="remarks"   style="margin-top: 24px;">
											    <label for="inputFloatingLabel-remarks" class="placeholder remarks">Remarks</label>
											</div>
							   	    	</div>

							   	    	 <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-date" type="date" class="form-control input-border-bottom" required=""  value="<?php  if(!empty($job_details)){ if($job->status=='Final Interview'  || $job->status=='Job Offered'){  echo $job_details->date;} } ?>"  name="date"  style="margin-top: 24px;">
