		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('organogram-chart/add-vw-level')}}"> Edit Level Details</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fa fa-bar-chart" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Level Details</h4>
								</div>
								<div class="card-body">
										...
										<div class="row form-group">
										  <div class="col-md-3">
										  	<div class=" form-group">	
   												<label for="inputFloatingLabel-shift-description" class="placeholder">Add Level</label>
										     	<input id="inputFloatingLabel-shift-description"  name="level" value="<?php  if(app('request')->input('id')){ echo $shift_management->level; } ?>" type="text" class="form-control input-border-bottom" required=""  placeholder="">
										    </div>
										  </div>
										</div>
										<div class="row form-group">											
