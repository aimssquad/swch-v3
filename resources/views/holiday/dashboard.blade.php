...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .dash-box{padding: 15px 30px;border-radius: 7px;    min-height: 126px;    margin-bottom: 26px;}
         .grn {background: #30a24b;}.red{background:#f3425f}.blue{background:#763ee7}.sky{background:#1878f3}.orange{background:orange}
         .dash-box img{width:30px}
         .dash-cont h4{color:#fff;padding-top:15px;font-size: 14px;}
   ...
   <body>
      <div class="wrapper">
         @include('holiday.include.header-dashboard')
         <!-- Sidebar -->
                           ...
                           <div class="dash-box grn">
                              <div class="row">
                                 <div class="col-md-8 col-8">
                                    <div class="dash-ico">
                                       <img src="{{ asset('assets/img/holiday-type.png')}}" alt="">
                                    </div>
                                    <div class="dash-cont">
                                       <h4> Number Of Holiday Type </h4>
                                    </div>
                                 </div>
                                 <div class="col-md-4 col-4">
                                    <div class="numb">
                                       <h5>{{ count($holiday_type)}}</h5>
                                    </div>
                                    <div class="view-more">
                                       <?php
                                          if( $usetype=='employee'){
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                           <div class="dash-box sky">
                              <div class="row">
                                 <div class="col-md-8 col-8">
                                    <div class="dash-ico">
                                       <img src="{{ asset('assets/img/annual-holiday.png')}}" alt="">
                                    </div>
                                    <div class="dash-cont">
                                       <h4>Annual Holiday List</h4>
                                    </div>
                                 </div>
                                 <div class="col-md-4 col-4">
                                    <div class="numb">
                                       <h5>{{ count($holiday_rs)}}</h5>
                                    </div>
                                    <div class="view-more">
                                       <?php
                                          if( $usetype=='employee'){
                           ...
                           <div class="dash-box blue">
                              <div class="row">
                                 <div class="col-md-8 col-8">
                                    ...
                                    <div class="dash-cont">
                                       <h4> Pro Rata Holiday Calculator
                                       </h4>
                                    </div>
                                 </div>
                                 <div class="col-md-4 col-4">
                                    ...
                                    <div class="view-more">
                                       <a href="https://www.gov.uk/calculate-your-holiday-entitlement" target="_blank">
                                       <img src="{{ asset('assets/img/login.png')}}"></a>
                                    </div>
                                 </div>
                              </div>
