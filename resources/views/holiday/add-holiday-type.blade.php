		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('holiday/add-holiday-type/')}}">Edit Holiday Type</a>
							</li>
				...
				<div class="page-inner">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="card-title"> <i class="fa fa-pencil-square" aria-hidden="true" style="color:#10277f;"></i>&nbsp; Edit Holiday Type</h4>
                            	@else
                                
							<h4 class="card-title"><i class="fas fa-calendar"></i> Add Holiday Type</h4>
                                @endif 
								</div>
								<div class="card-body">
									<form action="{{ url('holiday/add-holiday-type') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
			 ...
			 <input type="hidden" name="id" value="<?php  if(!empty($holidaydtl->id)){echo $holidaydtl->id;} ?>">
										<div class="row">
											...
											<div class="col-md-5"><div class="form-group">
											    	<label for="inputFloatingLabel" class="placeholder">Holiday Type</label>
			...
			@endif
											...
											<div class="col-md-6"><button type=submit" class="btn btn-default" style="margin-top:10px;">Submit</button></div>
											</div>
										</div>
									</form>
								</div>
