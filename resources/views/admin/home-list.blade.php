  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Home Office Client Visit</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Home Office Client Visit @if(count($hr_home_rs)!=0)

									<form  method="post" action="{{ url('superadmin/search-hrhome-excel') }}" enctype="multipart/form-data" >
