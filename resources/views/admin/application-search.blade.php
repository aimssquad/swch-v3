						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-newspaper"></i> Application status </h4></div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/view-search-application') }}" enctype="multipart/form-data" >
