...
?>
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Granted List</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Granted List @if(count($cos_granted_rs)!=0)

<form  method="post" action="{{ url('superadmin/search-granted-excel') }}" enctype="multipart/form-data" >
...
@endif
                        ...
                        <td>@if(count($pabillsts)!=0)
                            <a href="{{url('superadmin/bill-history/'.base64_encode($company->emid))}}" target="_blank"><i class="fas fa-eye"></i></a>
