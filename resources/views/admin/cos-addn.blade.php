						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-file-word"></i> New COS File</h4>
								</div>
								<div class="card-body">
									<form action="" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return validate();">
										...
										<div class="row form-group">
											...
											<input id="in_recruitment" type="hidden"  name="in_recruitment">
											<div class="col-md-4">
...
<script>
  ...
  function checkcompany(){
   ...
   function validate(){
	   if($("#in_recruitment").val()=='yes' && $("#employee_name").val()==''){
