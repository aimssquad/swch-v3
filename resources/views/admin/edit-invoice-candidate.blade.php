                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="fas fa-user"></i> Modify Invoice Candidate</h4>
                                </div>
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <input id="id" type="hidden" name="id" value="{{ $candidate->id }}">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select id="status" class="form-control input-border-bottom"
                                                        required name="status" value="{{$candidate->status}}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="address" type="text" name="address"
                                                        ...
                                                        required="">{{ $candidate->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
