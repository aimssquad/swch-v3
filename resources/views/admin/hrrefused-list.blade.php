  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Licence Rejected List</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Licence Refused List </h4>
...
->where(function ($query) {
 ...
 ->select('billing.*','tareq_app.ref_id')
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
											  <?php $i = 1; ?>
							@foreach($hr_refused_rs as $company)
								<?php
				...
				} if(!empty($company->refused_date)){
				  $refused_date='( '.date('d/m/Y',strtotime($company->refused_date)).' )' ;
