						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fab fa-searchengin"></i> Search</h4>
									@if(Session::has('message'))										
							<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
					@endif
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/search-complain') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
			   ...
			   <label for="inputFloatingLabel-select-date" class="placeholder" > To Date </label>
			    <input type="date" class="form-control input-border-bottom " name="end_date" id="inputFloatingLabel-select-date" required=""  style="margin-top: 16px;">
										    ...
										    <div class="sub-reset-btn">	
								     		<a href="#">	
										    <button class="btn btn-default" type="submit" style=" background-color: #1572E8!important; color: #fff!important;">View Search</button></a>
...
if(isset($result) && $result!=''  ){
											?>
										<form  method="post" action="{{ url('superadmin/search-complain-excel') }}" enctype="multipart/form-data" >
