...
<body>
  ...
  @include('admin.include.header')
	...
	<h4 class="card-title"><i class="fas fa-list"></i> Recruitment File Billed List @if(count($recruitementfile_billed_rs)!=0)

	<form  method="post" action="{{ url('superadmin/list-billed-recruitmentfile-export') }}" enctype="multipart/form-data" >
					...
					@endif
								...
								<div class="card-body">
									<form  method="get" action="{{ url('superadmin/list-billed-recruitmentfile') }}" enctype="multipart/form-data" >
                                    	<input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    	<div class="row form-group">
                                            <div class="col-md-5">
								     		...
								     		<div class="col-md-2 btn-up">
											  ...
											  <a class="btn btn-primary" href="{{ url('superadmin/list-billed-recruitmentfile') }}">Reset</a>
								     		</div>
										</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php $i = 1;?>
						@foreach($recruitementfile_billed_rs as $company)
				<tr>
