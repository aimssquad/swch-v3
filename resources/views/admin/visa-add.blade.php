						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-file-word"></i> New Visa Allocation</h4>
								</div>
								<div class="card-body">
					...
					<div class="col-md-4">
											<div class="form-group">
											    <label for="ref_id" class="placeholder" style="padding-top:0;margin-top: -10px;">Assign To</label>
											    	<select class="form-control input-border-bottom" id="ref_id" required=""  multiple data-live-search="true" name="ref_id[]">
													<option value="">&nbsp;</option>
