                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card custom-card">
                                ...
                                <h4 class="card-title"><i class="fas fa-user"></i> Candidates for Invoice
                                        <span> <a data-toggle="tooltip" data-placement="bottom"
                                                title="Add New Candidate"
                                                href="{{ url('superadmin/add-invoice-candidate') }}"><img
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="icon">
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit"
                                                            href='{{ url("superadmin/edit-invoice-candidate/".base64_encode($record->id)) }}'><img
                                                                style="width: 14px;"
