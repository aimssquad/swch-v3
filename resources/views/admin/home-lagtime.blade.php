  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Lag Time After Submission List</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Lag Time After Submission List @if(count($hr_lag_time_rs)!=0)
									
									<form  method="post" action="{{ url('superadmin/search-hrlagtime-excel') }}" enctype="multipart/form-data" >
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Lag Time After Submission </th>
													<th>Remarks</th>
