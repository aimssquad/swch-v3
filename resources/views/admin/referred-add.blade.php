				...
				<div class="page-inner">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="card-title"><i class="far fa-hand-point-right"></i> Add Referred</h4>
				...
				<input type="hidden" name="_token" value="{{ csrf_token() }}">	
										<div class="row form-group">
											...
											<div class="form-group">
												...
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="name"   >
											...
											<div class="col-md-3">
												...
												<input id="email" type="email"  class="form-control input-border-bottom" required="" name="email"  >
											...
											<div class="form-group">
												...
												<input id="phone" type="tel" class="form-control input-border-bottom" required="" name="phone"   >
											...
											<div class="form-group">
												...
												<select id="selectFloatingLabel3"  class="form-control input-border-bottom"  required name="status">
