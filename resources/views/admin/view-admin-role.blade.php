                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="far fa-user"></i> Admin Role Management <span><a
                                                href="{{url('superadmin/admin-role')}}" data-toggle="tooltip"
...
$useraccessdtl = DB::table('users_admin_emp')
    ...
    ->first();
$gtoo = DB::table('role_authorization_admin_user')
    ->join('module_admin', 'role_authorization_admin_user.module_name', '=', 'module_admin.id')

    ->where('role_authorization_admin_user.member_id', '=', $role->member_id)
    ->select('role_authorization_admin_user.*', 'module_admin.module_name')

    ->groupBy('role_authorization_admin_user.module_name')
