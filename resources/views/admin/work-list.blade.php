						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-pen-alt"></i> Daily Work Update</h4>
									@if(Session::has('message'))										
							<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
					@endif
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/work-update') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
                            ...
                            @endforeach
									 ...
									 <div class="col-md-4">
										    ...
										    <div class="sub-reset-btn">	
								     		<a href="#">	
    										    <button class="btn btn-default" type="submit" style="margin-top: 28px; background-color: #1572E8!important; color: #fff!important;">View Work Update</button></a>
...
if(isset($result) && $result!=''  ){
    ?>
         ...
         <td  >Total Target Hours :</td>
      
         <td>		 <?php

if(isset($result) && $result!=''  ){ echo $actual;}?></td>
  <td>Total Actual Hours :</td>
         <td> <?php

if(isset($result) && $result!=''  ){ echo $sum;}?></td>
<?php
}
?>
<td></td>
