  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
				<div class="page-header">
						<!-- <h4 class="page-title"> Partner Referral</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Partner Referral </h4>
...
->where(function ($query) {
 ...
 ->select('billing.*','tareq_app.ref_id')
									...
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
											  <?php $i = 1;  
											  ?>
							@foreach($or_partner_ref as $company)
								<?php
				...
				->first(); 
				$passnamereff=DB::Table('reffer_mas')
		        
			
				  ->where('ref_id','=',$company->reffered) 
		         
				->first();
				if(!empty($passnamereff)){
				    $ren=$passnamereff->name;
				}else{
				    $ren='';
				}
				if(!empty($pass)){
