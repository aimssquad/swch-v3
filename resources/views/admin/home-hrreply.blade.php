						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> HR Reply List @if(count($hr_reply_rs)!=0)
									
									<form  method="post" action="{{ url('superadmin/search-hrreply-excel') }}" enctype="multipart/form-data" >
