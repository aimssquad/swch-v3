			...
			<div class="content">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-envelope"></i> Message Center</h4>
								</div>
								<div class="card-body">
			 ...
			 {{csrf_field()}}
						...
						<div class="form-group">
													<label for="selectFloatingLabel" class="placeholder">Select Organisation</label>
													<select class="form-control input-border-bottom" id="selectFloatingLabel" name="emid" required="" onchange="billvalue(this.value);">
                                                                                <option value="">&nbsp;</option>
                            ...
                            <option value='{{ $billdept->reg}}' >{{ $billdept->com_name }}</option>
							 ...
							 @endforeach					
											...
											<div class="col-md-6">
												<div class=" form-group">
												    <label for="email" class="placeholder">Organization Email</label>
...
<script src="{{ asset('assets/js/core/jquery.3.2.1.min.js')}}"></script>
	...
	<script >
		$(document).ready(function() {
	   	...
	   	$.ajax({
		type:'GET',
		url:'{{url('pis/getbillorganmsgById')}}/'+empid,
        cache: false,
