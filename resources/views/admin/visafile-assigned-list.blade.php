										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												...
												<th>Sl.No.</th>
													...
													<th>Employee Name</th>
														<th>Need for COS Allocation</th>
															<th>Communication with Client</th>
													<th>Target Date for Sending Request to Home Office </th>
													<th>Target Date for Making Visa Application</th>
...
?>
				<tr>
							...
							<td>{{ $i }}</td>
							<td>{{ $pass->com_name }}</td>
							<td>{{ $company->emp_fname }} {{ $company->emp_mname }}
                                                        {{ $company->emp_lname }}</td>
                                  <td>{{ $pass->f_name }}</td>
                               <td>{{ $pass->l_name }}</td>
                                <td>{{ $pass->con_num }}</td>
