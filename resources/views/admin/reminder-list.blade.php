  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title">Invoice Reminder</h4> -->
						...
						<!--	</li>-->
						<!--	<li class="nav-item">-->
						<!--		<a href="{{url('superadmin/view-reminder')}}"> Invoice Reminder</a>-->
						<!--	</li>-->
						<!--</ul>-->
					</div>
			<div class="content">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-bell"></i> Invoice Reminder</h4>
									@if(Session::has('message'))										
							<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
					@endif
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/view-reminder') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
                            ...
                            @endforeach
										    ...
										    <div class="sub-reset-btn">	
								     		<a href="#">	
    										    <button class="btn btn-default" type="submit" style="margin-top: 28px; background-color: #1572E8!important; color: #fff!important;">View Reminder</button></a>
