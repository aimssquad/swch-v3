  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Licence Award Decision (Granted) List</h4> -->
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Licence Award Decision (Granted) List  
									@if(count($hr_granted_rs)!=0)
									
									<form  method="post" action="{{ url('superadmin/search-hraward-excel') }}" enctype="multipart/form-data" >
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Authorising officers first name</th>
															<th> Authorising officers last name</th>
																<th>Authorising officers contact number</th>
																	<th>Authorising officers email address</th>
													<th>Employee Name</th>
													<th>Start Date for HR File Preparation</th>
													<th>HR File Prearation Deadline</th>
													<th>Licence Award Decision</th>
...
@endif
                        ...
                        <td class="icon">@if(count($pabillsts)!=0)
                            <a data-toggle="tooltip" data-placement="bottom" title="View" href="{{url('superadmin/bill-history/'.base64_encode($company->emid))}}" target="_blank"><img  style="width: 17px;" src="{{ asset('assets/img/view.png')}}"></a>
