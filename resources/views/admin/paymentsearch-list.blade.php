						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-money-bill-wave-alt"></i> Payment Received Search</h4>
									@if(Session::has('message'))
							<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
					@endif
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/payment-search') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
										<div class="row">
...
<label for="status" class="placeholder"> Select Organisation</label>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-newspaper"></i> Payment Received Search</h4>
