  ...
  @include('admin.include.header')
		...
		<div class="main-panel">
			<div class="page-header">
						<!-- <h4 class="page-title"> Hr  File Update View</h4> -->
						...
						<!--	</li>-->
						<!--	<li class="nav-item">-->
						<!--		<a href="{{url('superadmin/view-hr')}}">  Hr  File Update View</a>-->
						<!--	</li>-->
						<!--</ul>-->
					</div>
			<div class="content">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-list"></i> Hr  File Update View</h4>
									@if(Session::has('message'))										
							<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
					@endif
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('superadmin/view-hr') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
...
<label for="employee_id" class="placeholder"> Select Employee</label>
                            ...
                            @endforeach
										    ...
										    <div class="sub-reset-btn">	
								     		<a href="#">	
    										    <button class="btn btn-default" type="submit" style="margin-top: 28px; background-color: #1572E8!important; color: #fff!important;">View Hr</button></a>
									...
									<div class="table-responsive">
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												...
												<th>Remarks-HR Preparation</th>
													<th>HR File Ready for Inspection</th>
													<th>Due Date for Home Office Feedback or Visit </th>
											<th>Lag Time After Submission </th>			<th>Licence Award Decision </th>		<th>Candidate Identified </th>
													<th>HR File Preparation Status </th>
													
												<th>Date</th>
													<th>Need action</th>
														<th>	Home Office Client Visit</th>
