...
<body>
  ...
  @include('admin.include.header')
	...
	<h4 class="card-title"><i class="fas fa-list"></i> Recruitment File Ongoing List @if(count($recruitementfile_requested_rs)!=0)

	<form  method="post" action="{{ url('superadmin/list-ongoing-recruitment-file-export') }}" enctype="multipart/form-data" >
					...
					@endif
								...
								<div class="card-body">
									<form  method="get" action="{{ url('superadmin/list-ongoing-recruitment-file') }}" enctype="multipart/form-data" >
                                    	<input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    	<div class="row form-group">
                                            <div class="col-md-5">
								     		...
								     		<div class="col-md-2 btn-up">
											  ...
											  <a class="btn btn-primary" href="{{ url('superadmin/list-ongoing-recruitment-file') }}">Reset</a>
								     		</div>
										</div>
