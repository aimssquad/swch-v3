...
<?php $j=1;?>
		...
		<div class="table-responsive">
										<table class="table">
										<tr><td><b>Shift Start Time :</b></td> <td>{{$value['shift_start_time']}}</td></tr>
										<tr><td><b>Shift End Time :</b></td> <td>{{$value['shift_end_time']}}</td></tr>
										<tr><td><b>Shift Description :</b></td> <td>{{$value['shift_des']}}</td></tr>
										<tr><td><b>Shift Code :</b></td> <td>{{$value['shift_code']}}</td></tr>
										<tr><td><b>Duty Hours :</b></td> <td>{{$value['duty_hours']}}</td></tr>
