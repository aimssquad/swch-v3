...
<?php $j=1;?>
  	...
  	?>
					<i class="fa fa-plus"></i>   {{$job_details->emp_fname}} {{$job_details->emp_mname}} {{$job_details->emp_lname}} ({{ $user->employee_id }})
		...
		<div class="table-responsive">
										...
										<tr><td><b>Status :</b></td> <td>{{ ucfirst($user->status) }}</td></tr>
