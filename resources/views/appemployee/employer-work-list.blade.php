						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-pen-alt"></i> Evidence of work</h4>
									
								</div>
								<div class="card-body">
									 <form  method="post" action="{{ url('appemployees/work-update') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
...
<label for="employee_id" class="placeholder"> Select Employee</label>
                            ...
                            <option value='{{ $dept->emp_code }}' <?php  if(isset( $employee_id)){ if($employee_id==$dept->emp_code){ echo 'selected'; } } ?> >{{ $dept->emp_fname }} {{ $dept->emp_mname }} {{ $dept->emp_lname }} ( {{ $dept->emp_code }} )</option>
                            ...
                            @endforeach
									 ...
									 <div class="col-md-4">
												...
												<input id="inputFloatingLabel-select-date"  type="date"  name="start_date" class="form-control input-border-bottom" required="">
												...
												<input id="inputFloatingLabel-select-date"  type="date" name="end_date" class="form-control input-border-bottom" required="">
										    ...
										    <div class="sub-reset-btn">	
								     		<a href="#">	
    										    <button class="btn btn-default" type="submit" style="margin-top: 28px; background-color: #1572E8!important; color: #fff!important;">View Evidence of work</button></a>
