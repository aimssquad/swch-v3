...
?>
  ...
  padding: 11px 0 0;
	...
	.main-panel{margin-top:0;}
.main-panel .content{margin-top:0;}</style>
</head>
<body>
	<div class="wrapper">
        ...
        <div class="row">
          <div class="col-12 col-lg-12 m-auto">
			  ...
			  <form name="basicform" id="basicform" method="post" action="{{url('appaddemployee?q='.my_simple_crypt($employee_rs[0]->emp_code, 'encrypt' ))}}" enctype="multipart/form-data" class="multisteps-form__form">
        {{ csrf_field() }}
              <!--single form panel-->
