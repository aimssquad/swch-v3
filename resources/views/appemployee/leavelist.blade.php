 ...
 $job_details=DB::table('employee')->where('emp_code', '=', $lvapply->employee_id )->where('emid', '=', $Roledata->reg )->orderBy('id', 'DESC')->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $lvapply->status_remarks }}</td>
                                                        ...
                                                        <a href="{{url('appleave-approver/leave-approved-right/'.base64_encode($employee_id).'/'.base64_encode($lvapply->id))}}"><img  style="width: 30px;" src="{{ asset('assets/img/edit.png')}}"></a>
                                                        @endif
														</td>
