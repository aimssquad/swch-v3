							...
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"> <i class="far fa-check-circle" aria-hidden="true" style="color:#10277f;"></i> &nbsp;Leave Allocation <span>
									    <a href="{{ url('applaeve/leave-management/save-leave-allocation/'.base64_encode($Roledata->reg)) }}" data-toggle="tooltip" data-placement="bottom" title="Add New Leave Allocation" >
							...
							?>
                                        <tr>
                                            ...
                                            <td class="icon">
                                                ...
                                                <a href='{{url("applaeve/leave-management/leave-allocation-dtl/".base64_encode($Roledata->reg)."/$leave_allo->id")}}' data-toggle="tooltip" data-placement="bottom" title="Edit" ><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
