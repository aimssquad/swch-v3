						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fa fa-hourglass-end" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Grace Period<span>		
									<a href="{{ url('approta/add-grace-period/'.base64_encode($Roledata->reg)) }}" data-toggle="tooltip" data-placement="bottom" title="Add Grace Period"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span>	
							</h4>
  ...
  ?>
                                        <tr>
                                           ...
                                           <td>{{ date('h:i a',strtotime($candidate->time_in)) }}</td>
                                            ...
                                            <td class="icon"><a href="{{url('approta/add-grace-period/'.base64_encode($Roledata->reg).'/')}}?id={{$candidate->id}}" data-toggle="tooltip" data-placement="bottom" title="Edit"  ><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
