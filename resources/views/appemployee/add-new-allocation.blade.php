...
<body>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card custom-card">
								...
								<div class="card-body">
									<form action="{{ url('applaeve/leave-management/get-leave-allocation') }}" method="post" enctype="multipart/form-data" >
  ...
  <div class="col-md-4">
								    ...
								    echo '<option value="' . $i . '">' . $i . '</option>' . PHP_EOL;
										...
										<form method="post" action="{{ url('applaeve/leave-management/save-leave-allocation') }}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
								 <input type="hidden" name="reg" value="<?php echo $Roledata->reg;?>">
