...
<body>
	<div class="wrapper">
        ...
        <div class="row">
          <div class="col-12 col-lg-12 m-auto">
			  ...
			  <form name="basicform" id="basicform" method="post" action="{{url('appaddallemployee?q='.my_simple_crypt($employee_rs[0]->emp_code, 'encrypt' ))}}" enctype="multipart/form-data" class="multisteps-form__form">
        {{ csrf_field() }}
              <!--single form panel-->
	...
	<div class="col-md-4">
	    	<input id="all" type="hidden" class="form-control input-border-bottom" required="" name="all"  value="{{$all}}" >
...
<td>
 ...
 @if ($tr_id==($countpay))
						 <button class="btn-success" type="button" id="add<?php echo $tr_id; ?>" onClick="addnewrow(<?php echo $tr_id; ?>)" data-id="<?php echo $tr_id; ?>"> <i class="fas fa-plus"></i> </button>
...
<?php $tretarin_id++; ?>
					...
					<div class="col-md-4" style="margin-top:13px;"><button class="btn-success" type="button" id="addtarin<?php echo $tretarin_id; ?>" onClick="addnewrowtarin(<?php echo $tretarin_id; ?>)" data-id="<?php echo $tretarin_id; ?>"><i class="fas fa-plus"></i> </button></div>
@endif
				  </div>
                 </div>
@endforeach   
			    ...
			    <input id="inputFloatingLabelib1" type="text" class="form-control input-border-bottom"  name="visa_issue" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->visa_issue; } ?>">	
				   ...
				   <div class="col-md-3">
							<div class="form-group" >
							    ...
							    <input id="visa_exp_date" onblur="getreviewvisdate();" type="date" class="form-control input-border-bottom" name="visa_exp_date" value="<?php  if(request()->get('q')!=''){  if($employee_rs[0]->visa_exp_date!='1970-01-01'){ if($employee_rs[0]->visa_exp_date!=''){ echo $employee_rs[0]->visa_exp_date;} } } ?>">	
																													</div>
			</div>
				   		<div class="col-md-3">
					...
					<div class="form-group">
					    ...
					    <input id="visa_review_date" readonly type="date" class="form-control input-border-bottom" name="visa_review_date" value="<?php  if(request()->get('q')!=''){  if($employee_rs[0]->visa_review_date!='1970-01-01'){ if($employee_rs[0]->visa_review_date!=''){ echo $employee_rs[0]->visa_review_date;} } } ?>">	
																													</div>
			</div>
						<div class="col-md-3">
	...
	@foreach($currency_user as $currency_valu)
				   ...
				   <div class="col-md-3">
							<div class="form-group" >
							    ...
							    <input id="nat_exp_date" type="date" class="form-control input-border-bottom" name="nat_exp_date" 
...
<label class="col-md-3 checkbox-inline"><input type="checkbox" name="professional_tax" value="1" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->professional_tax=='1'){ echo 'checked'; }else{ } } ?>> Prof Tax</label>
		  ...
		  <h3 class="multisteps-form__title" style="color: #1269db;border-bottom: 1px solid #ddd;padding-bottom: 11px;">Verification Status</h3>
				   ...
				   <div class="row form-group">
										...
										<div class="col-md-4">
										  <div class="form-group">
										  <label for="verify" class="placeholder">Verification Status</label>
										  <select id="verify"  class="form-control input-border-bottom"   name="verify_status">
