						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Employee <span><a href="{{ url('appaddemployee/'.base64_encode($emid)) }}"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <a class="dropdown-item" href="{{ url('appaddemployee/'.base64_encode($employee->emid)) }}?q={{ my_simple_crypt( $employee->emp_code, 'encrypt' )}}"><i class="far fa-edit"></i>&nbsp; Edit</a> 
