						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fa fa-cogs" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Duty Roster (Department wise)</h4>
								</div>
								<div class="card-body">
									<form action="{{ url('approta/add-department-duty') }}" method="post" enctype="multipart/form-data">
			 {{csrf_field()}}
								
 <input type="hidden" name="reg" value="{{ $Roledata->reg }}">								<div class="row form-group">
										   <div class="col-md-4">
...
$.ajax({
				type:'GET',
				url:'{{url('approta/getEmployeedesigBydutytshiftId')}}/'+val+'/'+emid,
				success: function(response){
