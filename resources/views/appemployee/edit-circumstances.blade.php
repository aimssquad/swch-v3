				...
				<div class="page-inner">
					...
					@endif
								...
								<div class="card-body" style="">
									<form action="{{url('appaddemployee-new/circumstances-edit-new')}}" method="post" enctype="multipart/form-data">
											 {{csrf_field()}}
											 <input  type="hidden" class="form-control input-border-bottom" required=""  name="emp_code"  value="{{ $employee_rs->emp_code}}">
										<input  type="hidden" class="form-control input-border-bottom" required=""  name="emid"  value="{{ $emid}}">
...
@endif
								<input type="file" accept="image/x-png,image/jpeg,image/png;capture=camera" class="form-control" name="doc_upload_doc_{{ $empuprs->id}}" id="doc_upload_doc<?php echo $truotherdocpload_id; ?>" onchange="Filevalidationdopassduploadnatother(<?php echo $truotherdocpload_id; ?>)">
								 <small> Please select  file which size up to 2mb</small>
						</div>
...
onchange="getreviewnatdateother(<?php echo $truotherdocpload_id; ?>);">	
			...
			<label for="doc_review_date" class="placeholder"  style="margin-top:-12px;">Eligible Review Date</label>																												</div>
							...
							<div class="col-md-3">
							<label>Upload Document</label>
								<input type="file" accept="image/x-png,image/jpeg,image/png;capture=camera" class="form-control" name="doc_upload_doc[]" id="doc_upload_doc<?php echo $truotherdocpload_id; ?>" onchange="Filevalidationdopassduploadnatother(<?php echo $truotherdocpload_id; ?>)">
								 <small> Please select  file which size up to 2mb</small>
						</div>
		 ...
		 <div class="col-md-4" style="margin-top:13px;"><button class="btn btn-success" type="button"  id="adduploadother<?php echo $truotherdocpload_id; ?>" onClick="addnewrowuploadother(<?php echo $truotherdocpload_id; ?>)" data-id="<?php echo $truotherdocpload_id; ?>"><i class="fas fa-plus"></i> </button></div>
						...
						<div class="col-md-3">
							...
							<div class="col-md-6">
								...
								<div class="form-group form-floating-label">
								    <label for="hr">Are Sponsored migrants aware that they must<br> inform [HR/line manager] promptly of <br>changes in contact Details</label>
							...
							<div class="col-md-6">
								...
								<div class="form-group form-floating-label">
						<label for="home">Are Sponsored migrants  aware that they need <br>to cooperate Home Office interview by <br>presenting original passports during the<br> Interview (In applicable cases)?
</label>
