...
<body>
	...
	<table border="1"  class="rtw-form-view"  style="border-collapse:collapse;max-width: 900px;width:100%;margin:auto;font-family: calibri;margin-bottom:10px;border: 1px solid #a863ed;">
		<tbody>
			...
			<tr>
				<td style="width: 200px; padding: 8px; background: #cc99ff;font-weight: 600;">Date of Check:</td>
				<td style="background: #f4e9f7;padding: 8px;">{{date('d/m/Y',strtotime($work_rs->date))}}</td>
			</tr>
			 <?php 
		 $timearray=array();
