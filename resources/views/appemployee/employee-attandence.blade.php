...
<div class="main-dash">
    ...
    text-align: center;
    margin-bottom: 0;
    padding: 5px 5px 8px;" class="text fw-bold">Date</h3>
		</div>
		<div class="col-md-12">
...
<?php $j=1;?>
		...
		<a class="btn btn-link @if($j!='1') collapsed @endif" data-toggle="collapse" data-target="#collapse<?=$j?>">
			<div class="card-header">
					...
					<i class="fa fa-plus"></i>   {{date('d-m-Y',strtotime($value['date']))}} 
...
<div class="table-responsive">
										<table class="table">
										<tr><td><b>Clock-In :</b></td> <td>{{$logvalue['timein']}}</td></tr>
										<tr><td><b>Clock-In  Location:</b></td> <td> {{$logvalue['time_in_location']}}</p></td></tr>
										<tr><td><b>Clock-Out :</b></td> <td> {{$logvalue['timeout']}}</p></td></tr>
