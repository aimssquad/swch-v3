				...
				<div class="page-inner">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								...
								<div class="card-body">
									 <form  method="post" action="{{ url('appemployees/task-save') }}" enctype="multipart/form-data" >
									 {{csrf_field()}}
									  ...
									  <input type="hidden" name="reg" value="{{ $Roledata->reg }}">
										...
										<div class="col-md-6">
											...
											<input id="file" type="file" accept="image/*;capture=camera"   class="form-control input-border-bottom"  name="file"  onchange="Filevalidationproimge()">
