						...
						<div class="col-md-12">
							<div class="card custom-card">
								...
								<div class="card-body" style="">
									<form action="{{url('settings/mode-emp-new-update')}}" method="post" enctype="multipart/form-data">
			 {{csrf_field()}}
									<div class="row">
										<div class="col-md-4">
										<div class="form-group">
                                            <input type="hidden" name="id" value="<?php print_r($enteries['0']->id) ?>">
											<label for="inputFloatingLabel" class="placeholder">Mode Of Employee</label>
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"  name="mode_emp_name" value="<?php print_r($enteries['0']->mode_emp_name) ?>">
											</div>
											</div>
                                            <div class="col-md-4">
										<div class="form-group">
