			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('settings/payitemlist')}}">BONUS RATE</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title">BONUS RATE
								</h4>
        ...
        <tbody>
            @foreach($bonas as $ratedtl)
                                    <tr>
    									...
    									<td><a href='{{url("settings/bonas-rate-get/$ratedtl->id")}}' data-toggle="tooltip"data-placement="bottom" title="Edit"><img  style="width: 19px;" src="{{ asset('assets/img/edit.png')}}"></a></td>
                                    </tr>
                                     @endforeach
