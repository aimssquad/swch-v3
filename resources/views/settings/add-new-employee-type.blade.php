						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-user"></i> New Employment Type</h4>
								</div>
								<div class="card-body" style="">
									<form action="{{ url('settings/employee-type') }}" method="post" enctype="multipart/form-data">
			 {{csrf_field()}}
