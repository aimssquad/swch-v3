			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('settings/vw-subcast')}}">caste</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i>caste 
<span>		<a href="{{ url('settings/add-sub-caste') }}" data-toggle="tooltip"data-placement="bottom" title="Add New"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
