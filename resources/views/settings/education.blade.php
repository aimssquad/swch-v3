						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i>education 
<span>		<a href="{{ url('settings/add-new-education') }}" data-toggle="tooltip"data-placement="bottom" title="Add New"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
