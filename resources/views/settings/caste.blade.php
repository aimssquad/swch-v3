			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('settings/vw-caste')}}">caste</a>
							</li>
...
<span>		<a href="{{ url('settings/add-new-caste') }}" data-toggle="tooltip"data-placement="bottom" title="Add New"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
