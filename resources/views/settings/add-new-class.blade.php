		...
		<div class="main-panel">
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
									<a href="{{url('settings/vw-class')}}">class</a>
							</li>
							<li class="separator">
								/
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i> New class</h4>
								</div>
			 ...
			 {{csrf_field()}}
									<div class="row">
										...
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">class Name</label>
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"  name="class_name" >
