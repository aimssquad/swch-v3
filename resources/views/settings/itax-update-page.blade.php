						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i> New ITEX RATE</h4>
								</div>
								<div class="card-body" style="">
									<form action="{{url('settings/itexaddfuncdetailupdate')}}" method="post" enctype="multipart/form-data">
			                     {{csrf_field()}}
									<div class="row">
										<div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">Surcharge Rate</label>
												<input id="inputFloatingLabel" type="number" class="form-control input-border-bottom" value="<?php print_r($itex['0']->surcharge) ?>"  name="surcharge"/>
										</div>
                                        </div>
                                        <div class="col-md-3">
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">E.Cess Rate</label>
												<input id="inputFloatingLabel" type="number" class="form-control input-border-bottom" value="<?php print_r($itex['0']->ecess) ?>"  name="ecess"/>
										</div>
                                        </div>
                                        <input type="hidden" name="id" value="<?php print_r($itex['0']->id) ?>">
                                        <div class="col-md-3">
										<div class="form-group">
