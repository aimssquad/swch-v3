        ...
        <tbody>
            @foreach($ratelist as $ratedtl)
                                    <tr>
    									...
    									<td><a href='{{url("settings/pay-item-details/$ratedtl->id")}}' data-toggle="tooltip"data-placement="bottom" title="Edit"><img  style="width: 19px;" src="{{ asset('assets/img/edit.png')}}"></a></td>
                                    </tr>
                                     @endforeach
