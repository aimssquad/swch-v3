					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="card-title"> Add Payment Type</h4>
								...
								<div class="card-body">
										<form action="{{ url('settings/pay-type') }}" method="post" enctype="multipart/form-data">
				  {{csrf_field()}}
				     <input type="hidden" name="paytypeid" value="{{ ((isset($paytypedetails) && !empty($paytypedetails))?$paytypedetails[0]->id:'')}}">
										...
										<div class="col-md-4">
											 <div class="form-group">
											 	<label for="inputFloatingLabel1" class="placeholder">Min. Working Hour</label>
										...
										<div class="col-md-4">
											 <div class="form-group">
											 	<label for="inputFloatingLabel2" class="placeholder">Rate</label>
