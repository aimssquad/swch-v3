				...
				<div class="page-inner">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-university"></i> Company </h4>
					...
					@endif
						...
						<tr>
                            ...
                            <td>{{ $companies_rs->fax }}</td>
                            <td>{{ $companies_rs->website }}</td>
                              <td>{{ $companies_rs->email }}</td>
                            <td>{{ $companies_rs->p_no }}</td>
                             <td>
                  <a href="{{url('settings/edit-company')}}?c_id={{$companies_rs->id}}"><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a> 
