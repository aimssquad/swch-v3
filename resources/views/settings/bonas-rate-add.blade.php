						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i> New BONUS RATE</h4>
								</div>
								<div class="card-body" style="">
									<form action="{{url('settings/bonusrateadd')}}" method="post" enctype="multipart/form-data">
			                     {{csrf_field()}}
									<div class="row">
										<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">Bonus Rate</label>
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"  name="bonusrate"/>
										</div>
                                        </div>
                                        <div class="col-md-4">
										<div class="form-group">
