		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('rota/offday')}}">Day Off</a>
							</li>
							...
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-calendar-times" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Day Off<span>
									    		<a href="{{ url('rota/add-offday') }}" data-toggle="tooltip" data-placement="bottom" title="Add Offday"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span>	
							</h4>
									...
									@endphp
										...
										<td> @if(!empty($employee_shift)) {!! $employee_shift->shift_code !!} ( {{ $employee_shift->shift_des }}  ) @endif</td>
											...
											@if(count($duty_roaster)==0)
												<a href="{{url('rota/add-offday/')}}?id={{$candidate->id}}" data-toggle="tooltip" data-placement="bottom" title="Edit"  ><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
											
											@endif
						
											</td>
                                        </tr>
										<?php //if($candidate->shift_code=='1339')die;?>
                                    @endforeach  
