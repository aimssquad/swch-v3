...
<head>
    ...
    WebFont.load({
        ...
        custom: {
            ...
            urls: ['{{ asset('
                employeeassets / css / fonts.min.css ')}}'
            ]
        },
        active: function() {
            ...
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item active">
                        <a href="{{url('rota/shift-management')}}">Shift Management</a>
                    </li>
                            ...
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="far fa-clock" aria-hidden="true"
                                            ...
                                            <a href="{{ url('rota/add-shift-management') }}" data-toggle="tooltip"
                                                data-placement="bottom" title="Add Shift Management"><img
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
														...
														<a href="{{url('rota/add-shift-management/')}}?id={{$candidate->id}}"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Edit"><img style="width: 14px;"
                                                                src="{{ asset('assets/img/edit.png')}}"></a>
                                                            <a href="{{ url('rota/delete-shift-management/' . $candidate->id) }}"
