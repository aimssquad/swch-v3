   ...
   <body>
            ...
            <div class="page-header">
               ...
               <ul class="breadcrumbs">
                  ...
                  <li class="nav-item active">
                     <a href="{{url('rota/add-department-duty')}}"> Add Department Wise Duty Roaster</a>
                  </li>
               </ul>
            </div>
            <div class="content">
      ...
      <script>
	   function dateValidation() {
           var fromDate = new Date($("#form_date").val());
            ...
            if (toDate.getTime() > oneMonthLater.getTime()) {
                alert("Date range should not be more than one month");
                return false; // Prevent form submission
            }
