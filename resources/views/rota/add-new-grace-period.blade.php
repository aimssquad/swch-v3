		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('rota/add-grace-period')}}"> Edit Grace Period Details</a>
							</li>
...
<label for="time_in" class="placeholder">Work In Time</label>
										     ...
										     <input id="time_in"  name="time_in" value="<?php  if(app('request')->input('id')){ echo $shift_management->time_in; } ?>" readonly type="time" class="form-control input-border-bottom" readonly required=""  placeholder="">
