								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tr>
											...
											<td style="text-align:center" id="myInput"><a href=" https://skilledworkerscloud.co.uk/hrms/visitor/{{ base64_encode($Roledata->reg) }}"target="_blank">
											   https://skilledworkerscloud.co.uk/hrms/rota/visitor/{{ base64_encode($Roledata->reg) }}
											    </a><button type="button" class="btn btn-default btn-copy js-tooltip js-copy" data-toggle="tooltip" data-placement="bottom" data-copy="https://hrmplus.co.uk/visitor/{{ base64_encode($Roledata->reg) }}" title="Copy Link">
