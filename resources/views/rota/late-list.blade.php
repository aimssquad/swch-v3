		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('rota/late-policy')}}">Late Policy</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									...
									<a href="{{ url('rota/add-late-policy') }}" data-toggle="tooltip" data-placement="bottom" title="Add Late Policy">
...
@if(Session::has('message'))										
  ...
  ?>
                                        <tr>
											...
											<td>{{ $candidate->shift_code }}  ( {{ $candidate->shift_des }}  )</td>
                                            ...
                                            <td><a href="{{url('rota/add-late-policy/')}}?id={{$candidate->id}}" data-toggle="tooltip" data-placement="bottom" title="Edit"  ><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
