		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('rota/grace-period')}}">Grace Period</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									...
									<a href="{{ url('rota/add-grace-period') }}" data-toggle="tooltip" data-placement="bottom" title="Add Grace Period"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span>	
							</h4>
  ...
  ?>
                                        <tr>
                                           ...
                                           <td>{{ date('h:i a',strtotime($candidate->time_in)) }}</td>
                                            ...
                                            <td class="icon"><a href="{{url('rota/add-grace-period/')}}?id={{$candidate->id}}" data-toggle="tooltip" data-placement="bottom" title="Edit"  ><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
