<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
					...
					<a href="{{url('interroatadashboard')}}"  class="logo">
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">
				...
				<div class="container-fluid">
					<!--<div class="collapse" id="search-nav">
						...
						<li><a href="{{url('interroatadashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Internal User Rota Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19"></a></i>
