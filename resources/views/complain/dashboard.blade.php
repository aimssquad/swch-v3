...
.dash-cont h4{color:#fff;padding-top:15px}
...
<body>
  ...
  @include('complain.include.header-dash')
		<!-- Sidebar -->
					 ...
					 <div class="col-md-4">
									  <div class="dash-box grn">
									    <div class="row">
										  <div class="col-md-8">
										    <div class="dash-ico">
											   <img src="{{ asset('assets/img/short.png')}}" alt="">
											</div>
											 <div class="dash-cont">
											   <h4>Open Complain </h4>
											 </div>
					 ...
					 <div class="col-md-4">
									  <div class="dash-box red">
									    <div class="row">
										  <div class="col-md-8">
										    <div class="dash-ico">
											  <img src="{{ asset('assets/img/intrvw.png')}}" alt="">
											</div>
											 <div class="dash-cont">
										  ...
										  <div class="col-md-4">
										    <div class="numb">
											  <h5>{{ count($solvedcomplain)}}</h5>
											</div>
												<div class="view-more">
											<a href="{{url('complain/view-solved-complain')}}"><img src="{{ asset('assets/img/login.png')}}"></a>
											</div>
										  </div>
										</div>
									  </div>
									    ...
									    <div class="row">
										  <div class="col-md-8">
										    <div class="dash-ico">
											 ...
											 <div class="dash-cont">
											   <h4>Closed Complain</h4>
											 </div>
										  </div>
										  <div class="col-md-4">
										    <div class="numb">
											  <h5>{{ count($closedcomplain)}}</h5>
											</div>
											
											<div class="view-more">
											 
											<a href="{{url('complain/view-closed-complain')}}"><img src="{{ asset('assets/img/login.png')}}"></a>
											</div>
										  </div>
										</div>
									  </div>
