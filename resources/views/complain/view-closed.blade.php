		    ...
		    <div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('complain/view-closed-complain')}}">Closed Complain</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-user"></i> Closed Complain
							</h4>
                                        ...
                                        <tr>
											...
											<td>{{ date('d/m/Y',strtotime($open->cr_date)) }} </td>
												<td>
												 ...
												 <td>
                                                      @if($open->up_date)
													{{ date('d/m/Y',strtotime($open->close_date)) }} 
												 @endif</td>
												<td>  {{ $open->remarks }}  </td>
