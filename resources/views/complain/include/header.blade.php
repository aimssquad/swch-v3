<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
					...
					<a href="{{url('complaindashboard')}}"  class="logo">
					<h2 style="margin-top:2px;color:#1572e8"><img src="{{ asset('img/logo.png')}}" alt="" width="178px" style="margin-top:-18px;"></h2>
				</a>
				...
				<div class="nav-toggle">
					<button class="btn btn-toggle toggle-sidebar">
						<i class="icon-menu" style="color: #0a4fa8;"></i>
					</button>
				</div>
			</div>
			<!-- End Logo Header -->
...
<li><a href="{{url('complaindashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Complain Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19"></a></i>
