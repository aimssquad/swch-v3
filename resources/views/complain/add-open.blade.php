										...
										<div class="row form-group">
											...
											<div class="form-group">
											   	...
											   	<select id="p_name"  class="form-control input-border-bottom"   name="p_name" required  onchange="heck_pname(this.value);">
											   	    	<option value=""   >&nbsp;</option>
							<option value="Work Permit Cloud"   >Work Permit Cloud</option>
							<option value="Skilled Worker Route"   >Skilled Worker Route</option>
										    ...
										    <div class="form-group">
												...
												<input id="others"  type="text" class="form-control input-border-bottom" name="others"  >
                       ...
                       @endforeach
										  ...
										  <div class="row">
											...
											<div class="form-group">
												...
												<textarea class="form-control input-border-bottom"  required name="descrption"></textarea>
