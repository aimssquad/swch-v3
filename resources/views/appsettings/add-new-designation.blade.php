			...
			<div class="content">
							...
							<div class="card">
								...
								<div class="card-body">
								   <?php if(isset($_GET['id'])){ 
								    ?>
									<form action="{{url('appsettings/designation?id='.$_GET['id'])}}" method="post" enctype="multipart/form-data">
									    <?php
								}else{
								    ?>
								     <form action="{{url('appsettings/designation')}}" method="post" enctype="multipart/form-data">
								    <?php
								}
								?>	   
			 ...
			 {{csrf_field()}}
						...
						<div class="form-group">
												<label for="selectFloatingLabel" class="placeholder">Select Department</label>
													<select class="form-control input-border-bottom" id="selectFloatingLabel" name="department_code" required="">
					...
					<div class="col-md-4">
					<div class="form-group">
					    <label for="inputFloatingLabel" class="placeholder">Designation Name</label>
