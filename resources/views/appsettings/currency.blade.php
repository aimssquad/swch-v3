						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"> Currency Master
<span>		<a href="{{ url('settings/currency') }}">Add New  Currency Master</a></span>								</h4>
           	...
           	@foreach($curren_rs as $grade)
                                        <tr>
                                            ...
                                            <td>{{ $grade->name}}</td>
                                               ...
                                               <td><a href="{{url('settings/currency')}}?id={{$grade->id }}"><img  style="width: 30px;" src="{{ asset('assets/img/edit.png')}}"></a>
