                                            ...
                                            <div class="text">
                                               <div class="avatar-box">
                                                  <div class="avatar avatar-xs">
                                                     <img src="{{ asset('frontend/assets/img/profiles/avatar-16.jpg')}}" alt="User Image">
                                                  </div>
                                               </div>
                                               <a href="profile.html">
                                                    Jeffery Lalor
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="project-members m-b-15">
                                ...
                                <ul class="team-members">
                                    <li>
                                        <a href="#" data-bs-toggle="tooltip" title="John Doe"><img src="{{ asset('frontend/assets/img/profiles/avatar-02.jpg')}}" alt="User Image"></a>
                                    </li>
                                    <li>
                                        <a href="#" data-bs-toggle="tooltip" title="Richard Miles"><img src="{{ asset('frontend/assets/img/profiles/avatar-09.jpg')}}" alt="User Image"></a>
                                    </li>
                                    <li>
                                        <a href="#" data-bs-toggle="tooltip" title="John Smith"><img src="{{ asset('frontend/assets/img/profiles/avatar-10.jpg')}}" alt="User Image"></a>
                                    </li>
                                    <li>
                                        <a href="#" data-bs-toggle="tooltip" title="Mike Litorus"><img src="{{ asset('frontend/assets/img/profiles/avatar-05.jpg')}}" alt="User Image"></a>
                                    </li>
                                    <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="project-members m-b-15">
                                ...
                                <ul class="team-members">
                                    <li>
                                        <a href="#" data-bs-toggle="tooltip" title="Jeffery Lalor"><img src="{{ asset('frontend/assets/img/profiles/avatar-16.jpg')}}" alt="User Image"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="project-members m-b-15">
