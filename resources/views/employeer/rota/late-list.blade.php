            ...
            <div class="card custom-card">
                <div class="card-header">
                    <h4 class="card-title"><i class="far fa-clock" aria-hidden="true"
                            style="color:#10277f;"></i>&nbsp;Late Policy<span>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                @foreach($employee_type_rs as $candidate)
                                        <?php
                                            $employee_desigrs=DB::table('designation')->where('id', '=',  $candidate->designation)->first();
                                            $employee_depers=DB::table('department')->where('id', '=',  $candidate->department)->first();
                                            $employee_shift=DB::table('shift_management')->where('id', '=',  $candidate->shift_code)->first();
                                        ?>
                                    <tr>
