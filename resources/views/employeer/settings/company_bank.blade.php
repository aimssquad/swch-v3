	...
	<div class="page-header">
		<div class="row align-items-center">
			...
			<div class="col-auto float-end ms-auto">
				...
				<a href="{{ url('org-settings/add-company-bank') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add  Company Bank</a>
				@endif
				@endforeach
		...
		<div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="far fa-bank" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Company Bank
                    </h4>
                    <div class="row">
                        <div class="col-auto">
                            <form action="{{ route('exportTableData') }}" method="POST" id="exportForm" class="d-inline">
                                ...
                                <input type="hidden" id="filenameInput" value="company-bank-list">
