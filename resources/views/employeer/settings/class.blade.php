...
<div class="content container-fluid pb-0">
   ...
   <div class="page-header">
      <div class="row align-items-center">
         <div class="col">
            <h3 class="page-title"> Employee Class</h3>
            <ul class="breadcrumb">
         ...
         <div class="col-auto float-end ms-auto">
            ...
            <a href="{{ url('org-settings/add-new-class') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add Sub Caste </a>
            @endif
            @endforeach
      ...
      <div class="col-md-12">
         <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
               <h4 class="card-title">
                   <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Employee Class
               </h4>
               <div class="row">
                  <div class="col-auto">
