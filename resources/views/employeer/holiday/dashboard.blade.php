                                    ...
                                    <div class="alert alert-primary border border-primary mb-0 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="text-primary w-100">
                                                ...
                                                <div class="fw-semibold d-flex justify-content-between text-card-size-fixed">Holiday Type</div>
                                ...
                                <div class="card border-0">
                                    <div class="alert alert-primary border border-primary mb-0 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="text-primary w-100">
                                                <i class="la la-dashboard rota-icon-size-fixed"></i>
                                                <div class="fw-semibold d-flex justify-content-between text-card-size-fixed">Holiday List</div>
                                                <div class="d-flex justify-content-between align-items-center">
