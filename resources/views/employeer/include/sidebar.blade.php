                            ...
                            @if($array_role['module_name'] ==1) 
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="leaves-employee.html">Employment Types</a></li>
                            ...
                            @if($array_role['module_name'] == 23) 
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="leaves-employee.html">Job Applied</a></li>
                                        <li><a href="leave-settings.html">Shotr listing</a></li>
                                        <li><a href="attendance.html">Interview</a></li>
                                        <li><a href="attendance-employee.html">Hired</a></li>
                                        <li><a href="departments.html">Generate Office Letter</a></li>
                                        <li><a href="designations.html">Search</a></li>
                                        <li><a href="timesheet.html">Status Search</a></li>
                                        <li><a href="shift-scheduling.html">Rejected</a></li>
                                        <li><a href="overtime.html">Message Center</a></li>   
                                    </ul>
                                </li>
                            @endif
                        @endforeach
                            ...
                            @if($array_role['module_name'] == 5) 
                                ...
                                <li class="submenu">Leave</span> <span class="menu-arrow"></span></a>
                                    <ul>   
                                        ...
                                        <li><a href="voice-call.html">Leave Rule</a></li>
                                        <li><a href="voice-call.html">Leave Allocation</a></li>
                                        <li><a href="voice-call.html">Leave Balance</a></li>
                                        <li><a href="voice-call.html">Leave Report</a></li>
                                        <li><a href="voice-call.html">Leave Report Employee Wise</a></li>                               
                                    </ul>
                                </li>
                            @endif
                        @endforeach
                        ...
                        @foreach($sidebarItems  as $array_role)
                            @if($array_role['module_name'] == 20) 
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>   
                                        <li><a href="voice-call.html">Project List</a></li>
                                        <li><a href="video-call.html">Create Project</a></li>                              
                                    </ul>
                                </li>
                            @endif
                        @endforeach
                        ...
                        @foreach($sidebarItems  as $array_role)
                            @if($array_role['module_name'] == 21) 
                                ...
                                <li class="submenu">
                                    ...
                                    <ul> 
                                        <li><a href="voice-call.html">All Sponsor Compliance</a></li>  
                                        ...
                                        <li><a href="video-call.html">Recruitment Process</a></li>            
                                        <li><a href="voice-call.html">Leave Management </a></li> 
                                        <li><a href="voice-call.html">Payroll </a></li> 
                                        <li><a href="voice-call.html">Key Contact </a></li> 
                                        <li><a href="voice-call.html">Sponsor Management Dossier</a></li> 
                                        <li><a href="voice-call.html">Monitoring & Reporting </a></li> 
                                        <li><a href="voice-call.html">Message Centre </a></li> 
