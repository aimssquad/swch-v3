   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <div class="col-auto float-end ms-auto">
            ...
            <a href="{{url('org-task-management/create-project')}}" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add Project </a>
            @endif
            @endforeach
      ...
      <div class="col-md-12">
         <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
               <h4 class="card-title">
                   <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Project List
               </h4>
               <div class="row">
                  <div class="col-auto">
               ...
               <div class="table-responsive">
                  <table class="table table-striped custom-table" id="basic-datatables">
                     ...
                     <tbody>
                      ...
                      <tr>
                          <td>{{$key+1}}</td>
                          <td><a href={{url('/task-management/'.encrypt($p->id).'/tasks')}}>{{$p->title}}</a></td>
                           ...
                           <td class="text-end">
                              <div class="dropdown dropdown-action">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @foreach($sidebarItems as $value)
                                    @if($value['rights'] == 'Add' && $value['module_name'] == 4 && $value['menu'] == 49)
                                    <a class="dropdown-item" href="{{url('/org-task-management/update-project/'.encrypt($p->id))}}">
                                    ...
                                    @foreach($sidebarItems as $value)
                                    @if($value['rights'] == 'Add' && $value['module_name'] == 4 && $value['menu'] == 49)
                                    <a class="dropdown-item" href='{{url('org-projects/del/'.encrypt($p->id))}}' onclick="return confirm('Are you sure you want to delete this Access?');"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                    @endif
                                    @endforeach
                                    @elseif($user_type == 'employer')
                                    <a class="dropdown-item" href='{{url('org-projects/del/'.encrypt($p->id))}}' onclick="return confirm('Are you sure you want to delete this Access?');"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
