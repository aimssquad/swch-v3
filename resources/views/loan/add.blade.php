            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title"><i class="fa fa-plus" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Add Loan</h4>
                  </div>
               ...
               <div class="card-body">
                  ...
                  <form action="{{url('loans/save-loan')}}" method="post" enctype="multipart/form-data" onsubmit="return validate();">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <button type="submit" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;Save</button>
                           <button type="reset" class="btn btn-warning btn-sm" onclick="select2_reset();"><i class="fa fa-ban"></i>&nbsp;Reset</button>
                        </div>
                     </div>
