            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title"><i class="fa fa-plus" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Adjust Loan</h4>
                  </div>
               ...
               <div class="card-body">
                  ...
                  <form action="{{url('loans/update-loan-adjustment')}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;Adjust (&#8377;{{$loan_balance}})</button>
