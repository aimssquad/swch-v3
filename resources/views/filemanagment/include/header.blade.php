<div class="main-header">
   ...
   "></a></li>
	...
	<li><a href="{{url('fileManagment/dashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Filemanagement Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19" ></a></i>
