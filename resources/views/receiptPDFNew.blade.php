                ...
                <tr>
                    ...
                    <td style="text-align: right; float: right;">
                        ...
                        <!-- <p style="margin-top: 0;"><span style="font-weight: 600;">Payment Method:</span>
                            {{$method}}</p> -->
                        <p style="margin-top: 0;"><span style="font-weight: 600;">Invoice Date:</span>
                            {{$date}}</p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border-right: 1px solid #000;text-align: right;border-bottom: 1px solid #000;">
                        £{{((float)$billing->anount_ex_vat) - ((float)$billing->due)}}</td>
                    ...
                    <td style="border-right: 1px solid #000;text-align: right;border-bottom: 1px solid #000;">
                        £{{ ((float)$billing->anount_ex_vat) -  ((float)$billing->due) - ((float)$billing->discount) }}
                    </td>
                    @if($billing->vat!=0)
                    <td style="border-right: 1px solid #000;text-align: right;border-bottom: 1px solid #000;">£
                        {{ round(((((float)$billing->anount_ex_vat)- ((float)$billing->due) - ((float)$billing->discount))*$billing->vat)/100,2) }}
                    </td>
                    @endif
                    <td style="text-align: right;border-bottom: 1px solid #000;">
                        £{{((float)$billing->net_amount)- ((float)$billing->due)}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right;border-bottom: 1px solid #000;border-right: 1px solid #000;">
                        £{{ ((float)$billing->anount_ex_vat) - ((float)$billing->discount) - ((float)$billing->due)}}
                    </td>
                ...
                <tr style="background-color: transparent;border: none;">
                    ...
                    <td style="border-bottom: 1px solid #000;border-right: 1px solid #000;" @if($billing->discount!=0)
                        colspan="2" @else colspan="1" @endif>Total
                        Excluding VAT</td>

                    <td style="text-align: right;border-bottom: 1px solid #000;border-right: 1px solid #000;">&pound;
                        {{ ((float)$billing->anount_ex_vat)- ((float)$billing->due) - ((float)$billing->discount) }}
                    </td>
                </tr>
                @if($billing->vat!=0)
                <tr style="background-color: transparent;border: none;">
                    ...
                    <td style="background: #dbe5f1;border-bottom: 1px solid #000;border-right: 1px solid #000;"
                        @if($billing->discount!=0) colspan="2" @else
                        colspan="1" @endif>VAT (GB VAT {{$billing->vat}}%)</td>
                ...
                <tr style="background-color: transparent;border: none;">
                    ...
                    <td style="border-right: 1px solid #000;" @if($billing->discount!=0) colspan="2" @else colspan="1"
                        @endif>Total Including VAT</td>

                    <td style="text-align: right;border-right: 1px solid #000;">&pound;
                        {{((float)$billing->net_amount)- ((float)$billing->due)}}</td>
                </tr>
            </tbody>
        </table>
