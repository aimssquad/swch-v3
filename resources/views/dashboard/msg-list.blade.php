						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"> <i class="far fa-envelope-open" aria-hidden="true" style="color:color:#10277f;"></i> &nbsp;Message Centre <span><a href="{{ url('dashboard/add-message-center') }}" data-toggle="tooltip" data-placement="bottom" title="Send Message"> <i class="fa fa-paper-plane" aria-hidden="true"></i> </a></span></h4>
