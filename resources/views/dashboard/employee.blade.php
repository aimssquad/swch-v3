		...
		<div class="page-header">
						...
						<li class="nav-home">
							...
							<li class="nav-item active">
								<a href="{{url('dashboard-employees')}}">  All Employee List</a>
							</li>
						</ul>
					</div>
			<div class="content">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-user" aria-hidden="true" style="color:#10277f;"></i> &nbsp; Employee  </h4> 
...
<td>    @if( $employee->emp_dob!='1970-01-01') @if( $employee->emp_dob!='') {{ date('d/m/Y',strtotime($employee->emp_dob)) }} @endif  @endif</td>
 ...
 <td>{{ $employee->pass_doc_no }}</td>
  ...
  @if( $employee->emp_pr_pincode) ,{{ $employee->emp_pr_pincode}} @endif  @if( $employee->emp_pr_country) ,{{ $employee->emp_pr_country}} @endif</td>
                    ...
                    <a href="{{ url('employee-add/employee-report/'.base64_encode($employee->emid).'/'.base64_encode($employee->emp_code)) }}" data-toggle="tooltip" data-placement="bottom" title="Download" ><img  style="width: 14px;" src="{{ asset('assets/img/download.png')}}"></a>
                                            </td>
                                            </tr>
                                     @endforeach  
