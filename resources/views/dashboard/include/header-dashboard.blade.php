<div class="main-header">
   ...
   margin-right:3px;"></a></li>
	<li><a href="{{url('dashboarddetails')}}" data-toggle="tooltip" data-placement="bottom" title="Sponsore Complaience Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19" style="margin-right:3px;"></a></i>
