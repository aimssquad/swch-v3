...
?>
    ...
    <div class="page-header">
						...
						<li class="nav-home">
							...
							<li class="nav-item active">
								<a href="{{url('dashboard-right-works')}}">Right To Work Checks</a>
							</li>						
						</ul>
					</div>
			<div class="content">
  ...
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="type[]" value="Initial check for new employee/applicant - required before employment" <?php if(in_array("Initial check for new employee/applicant - required before employment", $timearray)){ echo 'checked';}?> >Initial check for new employee/applicant - required before employment
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="type[]" value="Follow-up check on an existing employee - required before permission to work    expires (under List B - Group 1 or 2)"  <?php if(in_array("Follow-up check on an existing employee - required before permission to work    expires (under List B - Group 1 or 2)", $timearray)){ echo 'checked';}?>>Follow-up check on an existing employee - required before permission to work    expires (under List B - Group 1 or 2)
  </label>
</div>
      </div>
  </div>
...
?>
 ...
 <?php 
    ...
    <div class="col-md-12">
    	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_ap[]" value="A passport"  <?php if(in_array("A passport", $timearray)){ echo 'checked';}?>>A passport showing the holder, or a person named in the passport as the child of the holder, is a British citizen or a citizen of the UK and Colonies<br> having the right of abode in the UK.
  </label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_ap[]" value="A passport or national" <?php if(in_array("A passport or national", $timearray)){ echo 'checked';}?>>A passport or national identity card showing the holder, or a person named in the passport as the child of the holder, is a national of a European<br> Economic Area country or Switzerland.
  </label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_ap[]"  value="A Registration Certificate" <?php if(in_array("A Registration Certificate", $timearray)){ echo 'checked';}?>>A Registration Certificate or Document Certifying Permanent Residence issued by the Home Office, to a national of a European<br> Economic Area country or Switzerland.
  </label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_ap[]"  value="A Registration Certificate or Document" <?php if(in_array("A Registration Certificate or Document", $timearray)){ echo 'checked';}?>>A Permanent Residence Card issued by the Home Office, to the family member of a national of a European<br> Economic Area country or Switzerland.
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_ap[]"  value="A current Biometric Immigration" <?php if(in_array("A current Biometric Immigration", $timearray)){ echo 'checked';}?>>A current Biometric Immigration Document (Biometric Residence Permit) issued by the Home Office to the holder indicating that the person named<br> is allowed to stay indefinitely in the UK or has no time limit on their stay in the UK.   </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_ap[]"  value="A current passport endorsed" <?php if(in_array("A current passport endorsed", $timearray)){ echo 'checked';}?>>A current passport endorsed to show that the holder is exempt from immigration control, is allowed to stay indefinitely in the UK, has the right of abode<br> in the UK, or has no time limit on their stay in the UK.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_ap[]"  value="A current Immigration Status"  <?php if(in_array("A current Immigration Status", $timearray)){ echo 'checked';}?>>A current Immigration Status Document issued by the Home Office to the holder with an endorsement indicating that the named person is allowed to stay<br> indefinitely in the UK or has no time limit on their stay in the UK, together with an official document giving the person’s permanent National Insurance<br> number and their name issued
by a Government agency or a previous employer.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_ap[]" value="A birth (short or long) or adoption" <?php if(in_array("A birth (short or long) or adoption", $timearray)){ echo 'checked';}?>>A birth (short or long) or adoption certificate issued in the UK, together with an official document giving the person’s permanent National Insurance number<br> and their name issued by a Government agency or a previous employer.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_ap[]" value="A birth (short or long) or adoption certificate" <?php if(in_array("A birth (short or long) or adoption certificate", $timearray)){ echo 'checked';}?>>A birth (short or long) or adoption certificate issued in the Channel Islands, the Isle of Man or Ireland, together with an official document giving the person’s<br> permanent National Insurance number and their name issued by a Government agency or a previous employer.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_ap[]" value="A certificate of registration or naturalisation as a British" <?php if(in_array("A certificate of registration or naturalisation as a British", $timearray)){ echo 'checked';}?>>A certificate of registration or naturalisation as a British citizen, together with an official document giving the person’s permanent National Insurance number<br> and their name issued by a Government agency or a previous employer.</label>
</div>
    </div>
</div>
 <?php 
...
<div class="row form-group">
    <div class="col-md-12">
    	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_bp[]" value="A current passport endorsed to show that the holder"  <?php if(in_array("A current passport endorsed to show that the holder", $timearray)){ echo 'checked';}?> >A current passport endorsed to show that the holder is allowed to stay in the UK and is currently allowed to do the type of work in question.</label>
</div>

	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_bp[]" value="A current Biometric Immigration Document" <?php if(in_array("A current Biometric Immigration Document", $timearray)){ echo 'checked';}?>>A current Biometric Immigration Document (Biometric Residence Permit) issued by the Home Office to the holder which indicates that the named person<br> can currently stay in the UK and is allowed to do the work in question.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input"  name="list_bp[]" value="A current Residence Card" <?php if(in_array("A current Residence Card", $timearray)){ echo 'checked';}?>>A current Residence Card (including an Accession Residence Card or a Derivative Residence Card) issued by the Home Office to a non-European Economic <br>Area national who is a family member of a national of a European Economic Area country or Switzerland or who has a derivative right of residence.</label>
</div>

<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_bp[]" value="A current Immigration Status Document containing a" <?php if(in_array("A current Immigration Status Document containing a", $timearray)){ echo 'checked';}?>  >A current Immigration Status Document containing a photograph issued by the Home Office to the holder with a valid endorsement indicating that the<br> named person may stay in the UK, and is allowed to do the type of work in question, together with an official document giving the person’s permanent<br> National Insurance number and their
...
together with a Positive Verification Notice from the Home Office Employer Checking Service.</label>
	...
	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_bpc[]" value="An Application Registration Card issued" <?php if(in_array("An Application Registration Card issued", $timearray)){ echo 'checked';}?>>An Application Registration Card issued by the Home Office stating that the holder is permitted to take the employment in question, together<br> with a Positive Verification Notice from the Home Office Employer Checking Service.</label>
</div>

	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="list_bpc[]" value="A Positive Verification Notice"  <?php if(in_array("A Positive Verification Notice", $timearray)){ echo 'checked';}?>>A Positive Verification Notice issued by the Home Office Employer Checking Service to the employer or prospective employer, which indicates that the named<br> person may stay in the UK and is permitted to do the work in question.</label>
</div>
	</div>
</div>
...
electronically or in hardcopy. You must copy and retain:</p>
            ...
            <div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="passports[]" value="any page with the document"  <?php if(in_array("any page with the document", $timearray)){ echo 'checked';}?> >Passports: any page with the document expiry date, nationality, date of birth, signature, leave expiry date, biometric details and photograph, and any page<br> containing information indicating the holder has an entitlement to enter or remain in the UK and undertake the work in question.   </label>
</div>

  <div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" name="passports[]" value="All other documents" <?php if(in_array("All other documents", $timearray)){ echo 'checked';}?>>All other documents:the document in full,both sides of a Biometric Residence Permit.You must also record and retain the date on which the check was made.</label>
</div>
              </div>
          	...
          	<div class="col-md-12">
          		<table class="text-left table table-striped">
          			...
          			<tbody>
          				<tr>
          					<td>List A</td>
          					<td><input type="text" class="form-control" name="list_right" value="{{ $work_rs->list_right }}"></td>
          					<td><input type="text" class="form-control" name="list_right_follow" value="{{ $work_rs->list_right_follow }}"></td>
          					<td><input type="date" class="form-control" name="list_right_date"  value="@if($work_rs->list_right_date!='1970-01-01'){{ $work_rs->list_right_date }}@endif"></td>
          				</tr>
          				<tr>
          					<td>List B: (Group 1)</td>
          					<td><input type="text" class="form-control" name="list_rightb" value="{{ $work_rs->list_rightb }}"></td>
          					<td><input type="text" class="form-control" name="list_rightb_follow" value="{{ $work_rs->list_rightb_follow }}"></td>
                    <td><input type="date" class="form-control" id="list_rightb_date" name="list_rightb_date" value="@if($work_rs->list_rightb_date!='1970-01-01'){{ $work_rs->list_rightb_date }}@endif"></td>
          				...
          				<tr>
          					...
          					<td><input type="text" class="form-control" name="list_rightti" value="{{ $work_rs->list_rightti }}"></td>
          					<td><input type="text" class="form-control" name="list_rightti_follow" value="{{ $work_rs->list_rightti_follow }}"></td>
          					<td><input type="date" class="form-control" name="list_rightti_date" value="@if($work_rs->list_rightti_date!='1970-01-01'){{ $work_rs->list_rightti_date }}@endif"></td>
          				</tr>
          				<tr>
          					<td>List B: (Group 2)</td>
          					<td><input type="text" class="form-control" name="list_rightbs" value="{{ $work_rs->list_rightbs }}"></td>
          					<td><input type="text" class="form-control" name="list_rightbs_follow" value="{{ $work_rs->list_rightbs_follow }}"></td>
          				...
          				<input type="hidden" class="form-control" name="list_euss_date" id="list_euss_date"  value="@if($work_rs->list_euss_date!='1970-01-01'){{ $work_rs->list_euss_date }}@endif">
