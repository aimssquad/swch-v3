		...
		<ul class="breadcrumbs">
						<li class="nav-home">
							...
							<li class="nav-item active">
								<a href="{{url('contract-agreement')}}">Contract Agreement</a>
							</li>						
						</ul>
					</div>
			<div class="content">
					...
					@endif
						...
						<div class="col-md-12">
							<div class="card custom-card">
								...
								<div class="card-body">
									 <form  method="post" action="{{ url('dashboard/contract-agreement') }}" enctype="multipart/form-data" >
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"> <i class="fa fa-pencil-square" aria-hidden="true" style="color:#10277f;"></i> &nbsp;Contract Agreement</h4>
								</div>
								<div class="card-body">
