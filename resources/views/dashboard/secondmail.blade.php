...
<body>
  ...
  @if( $offer->emp_pr_pincode) ,{{ $offer->emp_pr_pincode}} @endif  @if( $offer->emp_pr_country) ,{{ $offer->emp_pr_country}} @endif</h3></td>
		...
		<tr>
			<td colspan="2">Date : {{date('d/m/Y',strtotime($offer->visa_exp_date.'  - 60  days'))}}</h3></td>
			
		</tr>

		<tr>
			<tr><td colspan="2">
				<p><b>Subject: Right to Work Documentation – Temporary Visa 60-day Reminder.</b>
<p>Further to your employment on a temporary visa, I am writing to remind you that this visa is due to
