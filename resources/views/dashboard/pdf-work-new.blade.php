...
<style type="text/css">
    ...
    div{position: relative;padding-left: 28px;}.rtw-form-view td {font-size: 13.5px;padding: 4px 6px !important;}
    .rtw-scan-main tr td{padding:4px 0 !important;}
    @print{
...
<body>
	...
	<table border="1"  class="rtw-form-view"  style="border-collapse:collapse;width:100%;margin:auto;font-family: calibri;margin-bottom:10px;border: 1px solid #a863ed;">
		<tbody>
...
?>
	...
	?>
	<table  class="rtw-form-view"  border="1" style="margin-bottom:10px !important;border-collapse:collapse;width:100%;margin:auto;font-family: calibri;border: 1px solid #c0504d;background: #f1dbdb;">
		
      <tr>
      	<td style="background: #c0504d;text-align: center;color: #fff;padding: 3px;">
...
<table border="1" class="rtw-form-view"  style="margin-bottom:10px !important;border-collapse:collapse;width:100%;margin:auto;font-family: calibri;border: 1px solid #9bba58;background: #eaf0dd;">
...
<?php 
	...
	?>
<table border="1" class="rtw-form-view" style="margin-bottom: :10px !important;border-collapse:collapse;width:100%;margin:auto;font-family: calibri;border: 1px solid #8063a1;background: #e4dfeb;">
...
<table border="1" style="border-collapse:collapse;width:100%;margin:30px auto 10px !important;overflow-x:scroll;font-family: calibri;border: 1px solid #8063a1;">
...
<table style="width:100%;margin:10px auto;" class="rtw-scan-main">
  @if($work_rs->scan_f_img!='')
	<tr>
		...
		<div class="text-center rtw-scan" style="font-family: calibri;padding-left: 0;">
              ...
              <p class="scan-body" style="background: #edecec;padding-left: 0;margin:0">
          ...
          <?php
            ...
            ?>
              ...
              <p class="scan-body" style="background: #edecec;padding-left: 0;margin:0" id="scan_nse_id"   @if($work_rs->scan_f_img!='' && $work_rs->scan_f=='visa_upload_doc' &&  isset($secod[1]) &&  $secod[1]!='')   style="display:block;margin-top:20px;padding-left:0;" @else style="display:none;margin-top:20px;padding-left:0;" @endif   >
  ...
  @if($work_rs->scan_s_img!='')
	<tr>
		...
		<td><div class="text-center rtw-scan" style="font-family: calibri;">
              ...
              <p class="scan-body" style="background: #e0f6ff;margin-top:0;border-bottom:none;margin-bottom:0'">
		...
		<td>
          ...
          <?php
            ...
            ?>
              ...
              <p class="scan-body" style="background: #ffedcb;margin-top:0;" id="scan_nrse_id"   @if($work_rs->scan_r_img!='' && $work_rs->scan_r=='visa_upload_doc' &&  isset($secod[1]) &&  $secod[1]!='')   style="display:block; margin-top:20px;padding-left:0;" @else style="display:none; margin-top:20px;padding-left:0;" @endif    >
...
<table border="1" style="margin-top:10px !important;border-collapse:collapse;width:100%;margin:10px auto;">
	<tr>
		<td style="font-size:13px;background: yellow;padding:5px;">RTW check result</td>
		<td style="font-size:13px;padding:5px;">{{$work_rs->result}}</td>
		<td style="font-size:13px;background: yellow;padding:5px;">Remarks</td>
		<td style="font-size:13px;padding:5px;">{{$work_rs->remarks}}</td>
	</tr>
...
<table border="1" style="margin-top:10px !important;border-collapse:collapse;max-width: 900px;width:100%;margin:10px auto;"> -->
	<tr>
		<td style="font-size:13px;padding:5px;background: #cbc0d9;">Checker's Name</td>
		<td  style="font-size:13px;padding:5px;">{{$work_rs->checker}}</td>
		<td style="font-size:13px;padding:5px;background: #cbc0d9;">Contact No.</td>
		<td style="font-size:13px;padding:5px;">{{$work_rs->contact}}</td>
	</tr>


	<tr>
		<td style="font-size:13px;background: #cbc0d9;padding:5px;background: #cbc0d9">Designation </td>
		<td style="font-size:13px;padding:5px;">{{$work_rs->designation}} </td>
		<td style="padding:5px; background: #cbc0d9;">Email Address</td>
		<td style="font-size:13px;padding:5px;">{{$work_rs->email}}</td>
	</tr>
