						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"> <i class="far fa-check-square" aria-hidden="true" style="color:#10277f;"></i> &nbsp; Right to Work checks <span><a href="{{ url('add-right-works-by-datecheck') }}"data-toggle="tooltip" data-placement="bottom" title="Add New Work Check"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
...
<td>   {{ date('d/m/Y',strtotime($employee->date)) }} </td>
 ...
 <td>{{ $employee->type }}</td>
                   ...
                   <td class="icon"> <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ url('dashboard/edit-work-view/'.base64_encode($employee->id)) }}" ><img  style="width: 15px;" src="{{ asset('assets/img/edit.png')}}"></a>
                                            </td>
