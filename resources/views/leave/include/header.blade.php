<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="{{url('leavedashboard')}}" class="logo">
    ...
    "></a></li>
	<li><a href="{{url('leavedashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Leave Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19"></a></i>
