		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('leave-management/leave-report')}}">Leave Report</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-file-archive" aria-hidden="true" style="color:#10277f;"></i> &nbsp;Leave Report </h4>
						 ...
						 @if(Session::has('message'))										
								...
								<div class="card-body">
								 <form  method="post" action="{{ url('leave-management/leave-report') }}" enctype="multipart/form-data" >
