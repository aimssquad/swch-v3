<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="{{url('employerdashboard')}}" class="logo">
					...
					<h2 style="margin-top:2px;color:#1572e8"><img src="{{ asset('img/logo.png')}}" alt="" width="200"></h2>
				</a>
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">
				...
				<div class="container-fluid">
				    ...
				    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li><a href="{{url('employeecornerdashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Employee Corner Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19"></a></i>
