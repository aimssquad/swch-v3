            ...
            <div class="user">
                ...
                <div class="info">
                    <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                        <span>
                            Employee Corner
                            <span class="user-level">@if(Session::get('user_type')=='employee')
...
?>
                    ...
                    <div class="collapse in" id="collapseExample">
                        <ul class="nav">
                            ...
                            <li>
                                <a href="{{url('employee-corner/change-password')}}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarLayouts">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="{{url('employee-corner/user-profile')}}">
                                    <span class="sub-item">View Profile</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="{{ url('employee-corner/update-profile') }}?q={{ my_simple_crypt( $dtaem->employee_id, 'encrypt' )}}">
                            ...
                            @if($enplit->emp_status=='CONTRACTUAL' || $enplit->emp_status=='FULL TIME' ||
                            $enplit->emp_status=='PART TIME')
                            <li>
                                <a href="{{url('employee-corner/contract-agreement')}}">
