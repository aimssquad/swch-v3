                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Daily Work Update <span style="background:none;">
                                        <?php if($user_type=="employer") {?>
                                        
                                        <?php }else{ ?>
                                        <a
                                                data-toggle="tooltip" data-placement="bottom" title=""
                                                href="{{url('employee-corner/add-work-update')}}"
                                                data-original-title="Add Work Update"> <img width="25px;"
                                                    src="{{ asset('img/plus1.png')}}"></a>
                                        <?php } ?>
                                        ...
                                        <table id="basic-datatables" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ $candidate->cmd }}</td>
                                                     <td><a href="{{url('employee-corner/work-edit/'.$candidate->id)}}"><img  style="width: 30px;" src="{{ asset('assets/img/edit.png')}}"></a></td>
                                                    <!--<td>-->
                                                    <!--    @if($candidate->file!='')-->
