  ...
  @include('employee-corner.include.header')
							...
							@endif
											...
											<div class="col-md-3">
												<div class="app-form-text date">
													<h5>Date Of Application:<span>
													     <input type="date" name="date_of_apply" id="date_of_apply" required>
										  ...
										  <div class="row form-group">
										   ...
										   <div class="col-md-4">
                                          	...
                                          	<label for="leave_type" class="placeholder">Leave Type</label><br/>
	...
	<label for="leave_inhand" class="placeholder">Leave In Hand</label>
                                    ...
                                    @endif
								     	  ...
								     	  <div class="col-md-4">
												<div class=" form-group form-floating-label">
                                                <label for="from_date"  class="placeholder">From Date</label><br/>
...
@if ($errors->has('from_date'))
								     ...
								     <div class="row form-group">
								     	  ...
								     	  <div class="col-md-4">
												<div class=" form-group form-floating-label">
                                                <label for="to_date"  class="placeholder">To Date</label><br/>
...
<label for="days" class="placeholder">No. Of Days</label>
								     ...
								     <div class="row form-group">
                                       	<div class="col-md-6">
										    	<a class="apply" href="#">
										        <button class="btn btn-default apply" type="submit" id="applysub">Apply</button>
										       </a>
										       <a class="apply" href="#">
