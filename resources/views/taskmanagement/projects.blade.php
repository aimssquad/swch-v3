					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="col-sm-12">
								...
								<input type="text" placeholder="" class="form-control form-control-sm mt-1" />
				...
				<div class="col-md-6">
					...
					<span class="right-brd" style="padding-right:15x;">
						<ul class="">
							<li><a href="#">Home</a></li>
							<li>/</li>
							<li><a href="#" data-toggle="modal" data-target=".bd-example-modal-lg2">Task Management</a></li>
							<li>/</li>
							<li><a href="#">Project List</a></li>
							<li>/</li>
							<li><a href="#" data-toggle="modal" data-target=".bd-example-modal-lg">New Task</a></li>
						</ul>
					</span>
				</div>
			</div>
