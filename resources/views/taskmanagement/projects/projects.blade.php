    ...
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item active">
                <a href="{{url('/task-management/projects')}}">Project List</a>
            </li>
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$p->status}}</td>
                                            <td>
                                                <a href="{{url('/task-management/update-project/'.encrypt($p->id))}}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                <a href="{{url('projects/del/'.encrypt($p->id))}}" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
