                ...
                <div class="col-md-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-header">
                            ...
                            <form method="POST" id="frm_project_roles">
                                <!-- <div id="message"></div> -->
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><?php //echo $l->status; 
                                                        ?></td> -->
                                            <td>
                                                <a href="{{url('task-management/'.request()->route('id').'/role-del/'.encrypt($l->id))}}" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
