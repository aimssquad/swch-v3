			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('company-level-user')}}">level 1 user</a>
							</li>
				...
				<div class="page-inner">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="flaticon-profile-1"></i> level 1 user </h4>
					...
					@if ($Roledata->level_f_name!='')								
						<tr>
                            ...
                            <td>	@if ($Roledata->level_proof!='')	<a href="{{ asset($Roledata->level_proof) }}" target="_blank">	<img src="{{ asset($Roledata->level_proof) }}" height="50px" width="50px"/></a>
																		@endif	</td>
