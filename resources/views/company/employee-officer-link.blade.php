			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('company-authorizing-officer')}}">Authorizing Officer</a>
							</li>
				...
				<div class="page-inner">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="flaticon-profile-1"></i> Authorizing Officer </h4>
					...
					@if ($Roledata->f_name!='')								
						<tr>
                            ...
                            <td>	@if ($Roledata->proof!='')	<a href="{{ asset($Roledata->proof) }}" target="_blank">	<img src="{{ asset($Roledata->proof) }}" height="50px" width="50px"/></a>
																		@endif	</td>
