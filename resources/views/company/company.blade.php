...
<link rel="icon" href="{{ asset('assets/img/icon.ico')}}" type="image/x-icon"/>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/line-awesome.min')}}">
			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('company-profile/company')}}">Organisation</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="far fa-building"></i>&nbsp; Organisation 
										<span><a data-toggle="tooltip" data-placement="bottom" title="Download in PDF" href="{{url('company/company-report/'.base64_encode($companies_rs->reg))}}"><img width="25" src="{{ asset('img/dnld.png')}}"></a></span></h4>
					...
					@endif
						...
						<tr>
                            ...
                            <td>{{ $companies_rs->p_no }}</td>
                             ...
                             <td>
                  <a style="    padding: 8px 0;" href="{{url('company-profile/edit-company')}}?c_id={{base64_encode($companies_rs->id)}}" data-toggle="tooltip" data-placement="bottom" title="Edit"><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a> 
