			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="#">Edit Organisation Profile {{Session::get('admin_userp_user_type')}}</a>
							</li>
			...
			<div class="content">
				<div class="page-inner">
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="flaticon-users"></i> Profile Update</h4>
					...
					@endif
								...
								<div class="card-body">
									<form action="{{url('company-profile/editcompany')}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
											 {{csrf_field()}}
                       ...
                       @endforeach
							              ...
							              <div class="col-md-3">
											...
											<div class="form-group">
												...
												<label for="inputFloatingLabel7" class="placeholder"> Country.  </label>
					...
					<div class="col-md-3">
										   ...
										   <div class="col-md-3">
											 ...
											 <select class="form-control input-border-bottom" id="inputFloatingLabel9"  name="com_year">
													<option value="">&nbsp;</option>
										   ...
										   <div class="col-md-3">
										     <div class="form-group">
												...
												<select class="form-control input-border-bottom" id="selectFloatingLabel1" name="com_nat">
													<option value="">&nbsp;</option>
                     ...
                     <option value="{{$nat_or->name}}" <?php if ($Roledata->com_nat == $nat_or->name) {echo 'selected';}?>>{{$nat_or->name}}</option>
                       @endforeach
										   ...
										   <div class="col-md-3 Other-service-activities" id="Other-service-activities" <?php if ($Roledata->com_nat == 'Other service activities') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
										    ...
										    <div class="col-md-4">
										     <div class="form-group">
										     	<label for="trad_status" class="placeholder">Have you changed Organisation /Trading  name in<br> last 5 years?    <span class="star">(*)</label>
                     ...
                     <option value="Yes" <?php if ($Roledata->trad_status == 'Yes') {echo 'selected';}?>>Yes</option>
                        <option value="No" <?php if ($Roledata->trad_status == 'No') {echo 'selected';}?>>No</option>
										    ...
										    <div class="col-md-4">
										     <div class="form-group">
										     	<label for="penlty_status" class="placeholder">Did your organisation faced penalty (e.g., recruiting<br>  illegal employee) in last  3 years?    <span class="star">(*)</label>
										      ...
										      <div class="form-group form-floating-label">
												...
												<label for="inputFloatingLabel14" class="placeholder">How Many Directors  </label>
													...
													<div class="col-md-3 form-group">
													    	<label for="exampleFormControlFile1" class="placeholder">Your Logo</label>
					...
					<div class="form-group">
					 ...
					 <div class="col-md-4">
										     <div class="form-group">
										     	<label for="key_bank_status" class="placeholder">Do you have a history of Criminal conviction<br>/Bankruptcy/Disqualification?    <span class="star">(*)</label>
					...
					<div class="form-group">
					 ...
					 <div class="col-md-4">
										     <div class="form-group">
										     	<label for="level_bank_status" class="placeholder">Do you have a history of Criminal conviction<br>/Bankruptcy/Disqualification?    <span class="star">(*)</label>
		...
		<label for="job_type1" class="placeholder">Job Type</label>
											...
											<div class="col-md-2">
											  ...
											  <div class="form-group " required>
												...
												<div class="col-md-3">
											  <div class="form-group" >
											  		<label for="immigration1" class="placeholder">Immigration Status</label>
...
@if(Session::get('admin_userp_user_type') == 'user')
										...
										<div class="col-md-3">
										     	<div class="form-group">
										         	<label for="last_date" class="placeholder" style="padding-top:0;">Verification  Date</label>
										...
										<div class="col-md-3">
										  <div class="form-group">
									<label for="verify" class="placeholder">Verification</label>
