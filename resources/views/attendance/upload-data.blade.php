		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('attendance/upload-data')}}">Upload Attendence</a>
							</li>
			...
			<div class="content">
				<div class="page-inner">
					...
					@endif
					 ...
					 <a class="d-block text-right" href="{{ asset('public/excel/attendence1.csv')}}" download>
                                                <button class="btn btn-default" >Download</button>
                                            </a>
									 <form  method="post" action="{{ url('attendance/upload-data') }}" enctype="multipart/form-data" >
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
										...
										<input type="file" id="upload_csv" name="upload_csv" class="form-control-file" required>
										  ...
										  <span>*Document Size Less Than 2 MB</span>
								     		...
								     		<div class="col-md-3">
								     		<a href="#">
    										    <button class="btn btn-default" type="submit">Upload</button></a>

										    <a href="#">
										    <button class="btn btn-default" type="reset">Reset</button></a>
