						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"> Short Listing  Details</h4>
								</div>
								<div class="card-body">
										...
										<div class="row form-group">
											...
											<div class=" form-group form-floating-label current-stage">		
											  ...
											  <select id="inputFloatingLabel-recruitment" class="form-control input-border-bottom" required="" name="status"  style="margin-top: 10px;">
												...
												<option value="L 1 Interview"  <?php  if($job->status!=''){  if($job->status=='L 1 Interview'){ echo 'selected';} } ?> >L 1 Interview</option>
                                      ...
                                      <div class="row form-group">
                                       <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-remarks" type="text" class="form-control input-border-bottom" value="<?php  if($job->remarks!='') {  if($job->status=='Hold' || $job->status=='L 1 Interview'){  echo $job->remarks;} } ?>" required="" name="remarks"   style="margin-top: 24px;">
							   	    	 ...
							   	    	 <div class="col-md-6">
											<div class=" form-group form-floating-label">	
											  <input id="inputFloatingLabel-date" type="date" class="form-control input-border-bottom" required=""  value="<?php  if(!empty($job_details)){ if($job->status=='Hold' || $job->status=='L 1 Interview'){  echo $job_details->date;} } ?>"  name="date"  style="margin-top: 24px;">
