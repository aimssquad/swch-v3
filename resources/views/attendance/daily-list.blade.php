		...
		<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('attendance/daily-attendance')}}">Daily Attendence</a>
							</li>
					...
					@endif
						...
						<div class="col-md-12">
							<div class="card custom-card">
								...
								<div class="card-body">
									 <form  method="post" action="{{ url('attendance/daily-attendance') }}" enctype="multipart/form-data" >
			...
			<div class="form-group">
				...
				<select class="form-control input-border-bottom" id="designation"  name="designation" required="" onchange="chngdepartmentdesign(this.value);">
					<option value="">&nbsp;</option>
										  ...
										  <div class="col-md-3">
												<div class=" form-group">
													<label for="inputFloatingLabel-select-date"  class="placeholder">Select Date</label>
