				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('attendance/attendance-report')}}"> Attendance Report </a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">  Attendance Attendance  Details</h4>
								</div>
								<div class="card-body">
								<form action="{{url('attendance/edit-report')}}" method="post" enctype="multipart/form-data">
			 {{csrf_field()}}
						<input id="id" type="hidden"  name="id" class="form-control input-border-bottom" required="" value="<?php   echo $job->id;  ?>" >
								...
								<div class="row form-group">
											 ...
											 <label for="inputFloatingLabel2" class="placeholder">Employment Type</label>
												<input id="inputFloatingLabel2" type="text" class="form-control " readonly  name="employee_type"  value="{{ $job_details->emp_status}}">
