			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('recruitment/capstone-assessment-report')}}">Capstone Assessment Report</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-briefcase"></i> Capstone Assessment Report
...
@if(Session::has('message'))										
					...
					@endif
								...
								@if(isset($interview_form_capstone) && count($recruitment_interviews)>0)
								<div class="card-body">
									<form action="{{ url('recruitment/capstone-assessment-report-pdf') }}" method="post" enctype="multipart/form-data">
			                            {{csrf_field()}}
