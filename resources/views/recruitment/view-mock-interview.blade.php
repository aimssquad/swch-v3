						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-archive"></i> View Mock Interview</h4>
								</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="col-md-12">
													<div class="form-group ">
														...
														<input type="text" id="institution" name="institution"  class="form-control" value="{{$recruitment_interviews->institution}}" readonly>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
														<label for="interviewer" class="placeholder">Interviewer Name</label>
															<input type="text" id="interviewer" name="interviewer"  class="form-control " value="{{$recruitment_interviews->interviewer}}" readonly>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="outcome_eligible" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="eligible" <?php if(isset($recruitment_interviews->outcome) && $recruitment_interviews->outcome=='eligible'){?>checked<?php } ?> disabled>
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="outcome_not_eligible" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="not eligible" <?php if(isset($recruitment_interviews->outcome) && $recruitment_interviews->outcome=='not eligible'){?>checked<?php } ?> disabled>
													...
													<div class="col-md-4">
														<div class="form-group ">
															<input type="radio" id="outcome_second_choice" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;" value="Second Choice" <?php if(isset($recruitment_interviews->outcome) && $recruitment_interviews->outcome=='Second Choice'){?>checked<?php } ?> disabled>
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="expected_salary_1" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;" value="National Minimum Wage" <?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='National Minimum Wage'){?>checked<?php } ?> disabled>
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="expected_salary_per_hour" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;" value="expected_salary_per_hour" <?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_hour'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="expected_salary_per_hour" id="expected_salary_per_hour" value="<?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_hour'){?>{{$recruitment_interviews->expected_salary_value}}<?php } ?>" style="border:0;border-bottom:1px solid;" readonly> / Hour
													...
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_week" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_week" <?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_week'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="expected_salary_per_week" id="expected_salary_per_week" value="<?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_hour'){?>{{$recruitment_interviews->expected_salary_value}}<?php } ?>" style="border:0;border-bottom:1px solid;" readonly> / Week
														</div>
	
													</div>
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_month" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_month" <?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_month'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="expected_salary_per_month" id="expected_salary_per_month" value="<?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_month'){?>{{$recruitment_interviews->expected_salary_value}}<?php } ?>" style="border:0;border-bottom:1px solid;" readonly> / Month
														</div>
	
													</div>
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_year" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_year" <?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_year'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="expected_salary_per_year" id="expected_salary_per_year" value="<?php if(isset($recruitment_interviews->expected_salary) && $recruitment_interviews->expected_salary=='expected_salary_per_year'){?>{{$recruitment_interviews->expected_salary_value}}<?php } ?>" style="border:0;border-bottom:1px solid;" readonly> / Year
														</div>
											...
											<div class="col-md-12">
												...
												<div class="row">
													...
													<div class="col-md-4">
														...
														<input type="radio" id="work_arrangement_day" name="work_arrangement"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="work_arrangement_day" <?php if(isset($recruitment_interviews->work_arrangement) && $recruitment_interviews->work_arrangement=='work_arrangement_day'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="work_arrangement_day" id="work_arrangement_day" value="<?php if(isset($recruitment_interviews->work_arrangement) && $recruitment_interviews->work_arrangement=='work_arrangement_day'){?>{{$recruitment_interviews->work_arrangement_value}}<?php } ?>" style="border:0;border-bottom:1px solid;"> Hours/Day
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group ">
															
															<input type="radio" id="work_arrangement_week" name="work_arrangement"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="work_arrangement_week" <?php if(isset($recruitment_interviews->work_arrangement) && $recruitment_interviews->work_arrangement=='work_arrangement_week'){?>checked<?php } ?> disabled> &pound; <input type="number" step="any" name="work_arrangement_week" id="work_arrangement_week" value="<?php if(isset($recruitment_interviews->work_arrangement) && $recruitment_interviews->work_arrangement=='work_arrangement_week'){?>{{$recruitment_interviews->work_arrangement_value}}<?php } ?>" style="border:0;border-bottom:1px solid;"> Hours/Week
											...
											<div class="col-md-6">
												<div class="form-group ">
													...
													<input type="date" id="expected_start_date" name="expected_start_date"  class="form-control" value="{{$recruitment_interviews->expected_start_date}}" readonly>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group ">
													<label for="comment" class="placeholder">Other Comment</label>
													<textarea id="comment" name="comment" class="form-control" readonly>{{$recruitment_interviews->comment}}</textarea>
												</div>
											</div>
