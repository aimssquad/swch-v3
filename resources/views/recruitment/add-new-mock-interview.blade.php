						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-archive"></i> <?php if (!empty($premock_interview->id)) {echo 'Edit';}else{ echo 'Add';}?> Mock Interview</h4>
								</div>
											...
											<div class="col-md-6">
												...
												<div class="col-md-12">
													<div class="form-group ">
														...
														<input type="text" id="total_exp" name="total_exp"  class="form-control" disabled>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
														<label for="present_employer" class="placeholder">Present Employer</label>
														<input type="text" id="present_employer" name="present_employer"  class="form-control" disabled>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
														<label for="highest_education" class="placeholder">Highest Education</label>
														<input type="text" id="highest_education" name="highest_education"  class="form-control" disabled>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
												...
												<div class="col-md-12">
													<div class="form-group ">
														<label for="interview_time" class="placeholder">Interview Time</label>
															<input type="text" id="interview_time" name="interview_time"  class="form-control "   value="<?php if (!empty($premock_interview->interview_time)) {echo $premock_interview->interview_time;}?>" required>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
														<label for="present_position" class="placeholder">Present Position</label>
														<input type="text" id="present_position" name="present_position"  class="form-control" disabled>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group ">
										            ...
										            <table class="display table table-hover" border=1 style="border-color:#ccc;">
                                                        ...
                                                        @foreach($interview_form_capstone as $capstone)
                                                            ...
                                                            <tr>
																...
																<td>
																<textarea name="comment_{{$ques->id}}" id="comment_{{$ques->id}}" rows=2 cols=50 class="form-control"></textarea>

																<input type="hidden" name="rating_{{$ques->id}}" id="rating_{{$ques->id}}" value="0" readonly=true class="secrate_{{$capstone->id}} cafrate_{{$ques->form_cognitive_ability_id}}">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="outcome_eligible" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="eligible" required>
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="outcome_not_eligible" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="not eligible" required>
													...
													<div class="col-md-4">
														<div class="form-group ">
															<input type="radio" id="outcome_second_choice" name="outcome"  style="float: left;clear: none;margin: 2px 0 0 2px;" value="Second Choice" required>
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group ">
															...
															<input type="radio" id="expected_salary_1" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="National Minimum Wage" required>
															<label for="expected_salary_1" class="placeholder" style="float: left;clear: none;display: block;padding: 0px 1em 0px 8px;">National Minimum Wage</label>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group ">
															
															<input type="radio" id="expected_salary_per_hour" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_hour" required> &pound; <input type="number" step="any" name="expected_salary_per_hour" id="expected_salary_per_hour" value="" style="border:0;border-bottom:1px solid;"> / Hour
													...
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_week" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_week" required> &pound; <input type="number" step="any" name="expected_salary_per_week" id="expected_salary_per_week" value="" style="border:0;border-bottom:1px solid;"> / Week
														</div>
	
													</div>
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_month" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_month" required> &pound; <input type="number" step="any" name="expected_salary_per_month" id="expected_salary_per_month" value="" style="border:0;border-bottom:1px solid;"> / Month
														</div>
	
													</div>
													<div class="col-md-4">
														<div class="form-group ">
														<input type="radio" id="expected_salary_per_year" name="expected_salary"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="expected_salary_per_year" required> &pound; <input type="number" step="any" name="expected_salary_per_year" id="expected_salary_per_year" value="" style="border:0;border-bottom:1px solid;"> / Year
														</div>
											...
											<div class="col-md-12">
												...
												<div class="row">
													...
													<div class="col-md-4">
														...
														<input type="radio" id="work_arrangement_day" name="work_arrangement"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="work_arrangement_day" required> &pound; <input type="number" step="any" name="work_arrangement_day" id="work_arrangement_day" value="" style="border:0;border-bottom:1px solid;"> Hours/Day
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group ">
															
															<input type="radio" id="work_arrangement_week" name="work_arrangement"  style="float: left;clear: none;margin: 2px 0 0 2px;"   value="work_arrangement_week" required> &pound; <input type="number" step="any" name="work_arrangement_week" id="work_arrangement_week" value="" style="border:0;border-bottom:1px solid;"> Hours/Week
