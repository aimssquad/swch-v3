			...
			<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('recruitment/reject')}}"> Rejected</a>
							</li>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-user-times"></i> Rejected
							</h4>
...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <a class="dropdown-item" href="{{url('recruitment/edit-reject/'.base64_encode($candidate->id))}}"><i class="far fa-edit"></i>&nbsp; Edit</a> 
    <a download class="dropdown-item" href="{{asset('public/'.$candidate->resume)}}"><i class="fas fa-download"></i>&nbsp; Download</a> 
  </div>
</div>


<!--recruitment/edit-reject/'.base64_encode($candidate->id))-->
