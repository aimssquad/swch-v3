...
<body style="position: relative;">
	<div class="wrapper">
        <div style="padding:5px">
            <div class="row">
                <div class="col-md-12">
                    <h1 style="text-align:center">Cognitive Ability Assessment Report</h1>
                    ...
                    <table  width="100%" style="font-family:calibri;padding: 0 15px;">
                        <thead>
                            <tr>
                                ...
                                <th style="background-color:#2caaed;color:#fff;">{{ $rec->cognitive_ability_name }}</th>
                                @endforeach
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endforeach
                                <td style="text-align:center">{{ $record->caf_score }}</td>
