						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"><i class="fas fa-money-bill"></i> New Billing</h4>
								</div>
								<div class="card-body">
									<form action="" method="post" enctype="multipart/form-data">
			 {{csrf_field()}}
			 	<input id="emid" type="hidden"  name="emid"    class="form-control input-border-bottom" required="" value="{{$Roledata->reg}}" style="margin-top: 22px;" >
						...
						<div class="form-group">
						    	<label for="emid" class="placeholder"> Organisation</label>
												<input id="emidname" type="text"  name="emidname"    class="form-control input-border-bottom" required="" style="margin-top: 22px;"  value="{{$Roledata->com_name}}" readonly>
													...
													<!--<select class="form-control input-border-bottom" id="selectFloatingLabel" name="emid" required="">
                                                                                <option value="">&nbsp;</option>
