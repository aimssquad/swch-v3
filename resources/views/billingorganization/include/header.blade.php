<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
					...
					<a href="{{url('billingorganizationdashboard')}}"  class="logo">
   ...
   "></a></li>
	<li><a href="{{url('billingorganizationdashboard')}}" data-toggle="tooltip" data-placement="bottom" title="Billing Dashboard"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" width="19"></a></i>
