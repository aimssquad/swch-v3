       ...
       <div class="container-fluid">
          <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
             <li><a data-toggle="tooltip" data-placement="bottom" title="Main Dashboard" href="{{url('employerdashboard')}}"><img src="{{ asset('assets/img/home.png')}}" alt="" style="width: 19px;
                "></a></li>
             <li><a data-toggle="tooltip" data-placement="bottom" title="Circumtances Dashboard" href="{{url('circumtances/dashboard')}}"><img src="{{ asset('assets/img/dashboard.png')}}" alt="" style="width: 19px;
                "></a></li>
             <li>
