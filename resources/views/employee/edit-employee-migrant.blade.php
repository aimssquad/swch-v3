...
.card-body{padding:0;}.footer{position:relative;}
  </style>
</head>
<body>
  <div class="wrapper">
...
/
              ...
              <li class="nav-item">
                <a href="{{url('migrant-employees')}}">Migrant Employee</a>
              </li>
              <li class="separator">
              /
              </li>
              <li class="nav-item active">
                <a href="#">Edit New Migrant Employee</a>
              </li>
            </ul>
          </div>
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card custom-card">
                <div class="card-header">
                  <h4 class="card-title"><i class="far fa-user"></i> Edit New Migrant Employee</h4>
                </div>
...
<input id="inputFloatingLabelni" type="text" class="form-control input-border-bottom" name="ni_no" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->ni_no; } ?>">
  ...
  <div class="col-md-4">
    ...
    <input id="inputFloatingLabeldob" type="date" class="form-control input-border-bottom" name="emp_dob" value="<?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_dob!='1970-01-01'){ if($employee_rs[0]->emp_dob!=''){ echo $employee_rs[0]->emp_dob;} } } ?>">
...
<input id="inputFloatingLabelpb" type="text" class="form-control input-border-bottom" name="place_birth" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->place_birth; } ?>">
      ...
      <input id="inputFloatingLabelib" type="text" class="form-control input-border-bottom"  name="issue_by" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->issue_by; } ?>">
          ...
          <input id="pass_review_date" type="date" class="form-control input-border-bottom" name="pass_review_date"  readonly value="<?php  if(request()->get('q')!=''){  if($employee_rs[0]->pass_review_date!='1970-01-01'){ if($employee_rs[0]->pass_review_date!=''){ echo $employee_rs[0]->pass_review_date;} } } ?>"> 
                                                         </div>
      </div>
