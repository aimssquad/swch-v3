                  ...
                  <div class="col-md-12">
                     <div class="card custom-card">
                        <div class="card-header">
                           <h4 class="card-title"><i class="far fa-user"></i> Edit New Employee</h4>
                        </div>
                        <div class="card-body">
                                             ...
                                             <div class="row">
                                                <div class="col-md-3">
                                                   <div class="form-group">
                                                      ...
                                                      <select class="form-control input-border-bottom" id="dbs_type"  name="dbs_type" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->dbs_type;}?>">
                                                         <option value="">&nbsp;</option>
                                                ...
                                                <div class="col-md-3">
                                                   <div class="form-group">
                                                      <label for="selectFloatingLabelntp" class="placeholder">Nationality</label>
                                                      <select class="form-control input-border-bottom" id="selectFloatingLabelntp"  name="dbs_nation" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->dbs_nation;}?>">
                                                         <option value="">&nbsp;</option>
                                                         @foreach($currency_user as $currency_valu)
