                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title">Recruitment File
                                        @if(!empty($recruitment_file_apply))
                                        <span><a href="{{ url('organisation-status/add-recruitment-file') }}" data-toggle="tooltip"
                                                data-placement="bottom" title="Add New Employee Recruitment File"><img
                                        ...
                                        <table id="basic-datatables" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $company->candidate_hired }}</td>
                                                    <td>{{ $company->stage_name }}</td>
                                                    <td>{{ $company->remarks }}</td>

                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit"
                                                            href="{{url('organisation-status/edit-recruitment-file/'.base64_encode($company->id))}}"><img
                                                                style="width: 14px;"
