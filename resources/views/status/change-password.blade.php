...
<body>
  ...
  @include('status.include.header')
		    	...
		    	<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item active">
								<a href="{{url('organisation-status/change-password')}}">Change Password</a>
							</li>
    ...
    <label for="old" class="placeholder">Old Password</label>
								     		  ...
								     		  <input  type="text"  name="old" class="form-control input-border-bottom"  id="old" required=""   placeholder="" >
  ...
  <div class=" form-group">
       <label for="new_p" class="placeholder">New Password</label>
								     		  <input  type="text"  name="new_p" class="form-control input-border-bottom"  id="new_p" required=""   placeholder="">
								     		...
								     		<div class="col-md-4">
								     		    <div class=" form-group">
    		<label for="con" class="placeholder">Cormfirm Password</label>	 

								     		  <input  type="text"  name="con" class="form-control input-border-bottom"  id="con" required=""   placeholder="" >
