...
<body>
						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title">Visa File  <span><a href="{{ url('organisation-status/add-visa') }}">Add Visa File</a></span></h4>
 ...
 href="{{url('organisation-status/edit-visa/'.base64_encode($company->id))}}"><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a> 
                  </td> 
