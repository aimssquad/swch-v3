                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="far fa-folder"></i> Add Visa File</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{url('organisation-status/add-visa-file')}}" method="post"
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <textarea id="remarks" name="remarks"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;">{{$visa_file_apply->remarks}}</textarea>
