                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="far fa-folder"></i> Edit COS File</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{url('organisation-status/edit-cos')}}" method="post"
...
?>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="employee_name" type="text" name="employee_name"
                                                        ...
                                                        style="margin-top: 22px;" value="{{$hr->employee_name}}" required @if(!empty($recruitment)) readonly @endif>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="cos" name="cos"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->cos=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->cos=='No') selected @endif>No
                                                        </option>
                                                        <option value="Not Known" @if($hr->cos=='Not Known') selected
                                                            @endif>Not Known</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="applied_cos_date" type="date" name="applied_cos_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->applied_cos_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="type_of_cos"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="defined" @if($hr->type_of_cos=='defined') selected @endif>Defined
                                                        </option>
                                                        <option value="undefined" @if($hr->type_of_cos=='undefined') selected @endif>Undefined
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="type_of_cos_date" type="date" name="type_of_cos_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->type_of_cos_date}}">
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="additional_info_requested"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->additional_info_requested=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->additional_info_requested=='No') selected @endif>No
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="additional_info_request_date" type="date" name="additional_info_request_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->additional_info_request_date}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="additional_info_sent"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->additional_info_sent=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->additional_info_sent=='No') selected @endif>No
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="additional_info_sent_date" type="date" name="additional_info_sent_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->additional_info_sent_date}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="cos_assigned"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->cos_assigned=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->cos_assigned=='No') selected @endif>No
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="cos_assigned_date" type="date" name="cos_assigned_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->cos_assigned_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="client"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->client=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->client=='No') selected @endif>No
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="identified"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->identified=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->identified=='No') selected @endif>No
                                                        </option>
                                            ...
                                            <div class="col-md-8">
                                                <div class=" form-group">
                                                    ...
                                                    <textarea id="remarks_cos" name="remarks_cos"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;">{{$hr->remarks_cos}}</textarea>
                                            ...
                                            <!-- <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="target_date" type="date" name="target_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->target_date}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom"
                                                        ...
                                                        style="margin-top: 22px;">
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->allocation_status=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->allocation_status=='No') selected
                                                            @endif>No</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom"
                                                        ...
                                                        style="margin-top: 22px;">
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->job_offer_status=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->job_offer_status=='No') selected
                                                            @endif>No</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <input id="visa_date" type="date" name="visa_date"
                                                        class="form-control input-border-bottom"
                                                        style="margin-top: 22px;" value="{{$hr->visa_date}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="visa_app"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->visa_app=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->visa_app=='No') selected @endif>No
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="fur_query"
                                                        ...
                                                        style="margin-top: 22px;">
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->fur_query=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->fur_query=='No') selected @endif>No
                                                        </option>

                                                        <option value="Not Known" @if($hr->fur_query=='Not Known')
                                                            selected @endif>Not Known</option>
                                            ...
                                            <div class="col-md-6 " id="criman_bank_new" @if($hr->fur_query=='Yes')
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="visa_stat"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->visa_stat=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->visa_stat=='No') selected @endif>No
                                                        </option>

                                                        <option value="Not Known" @if($hr->visa_stat=='Not Known')
                                                            selected @endif>Not Known</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="appeal"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Yes" @if($hr->appeal=='Yes') selected @endif>Yes
                                                        </option>
                                                        <option value="No" @if($hr->appeal=='No') selected @endif>No
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-border-bottom"
                                                        id="responsible" type="text" name="responsible"
                                                        value="{{$hr->responsible}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="app_stat"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Done" @if($hr->app_stat=='Done') selected
                                                            @endif>Done</option>
                                                        <option value="Not Done" @if($hr->app_stat=='Not Done') selected
                                                            @endif>Not Done</option>

                                                        <option value="NA" @if($hr->app_stat=='NA') selected @endif>NA
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="app_out"
                                                        ...
                                                        <option value="">&nbsp;</option>
                                                        <option value="Further Proceedings" @if($hr->app_out=='Further
                                                            Proceedings') selected @endif>Further Proceedings</option>

                                                        <option value="No" @if($hr->app_out=='No') selected @endif>No
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class=" form-group">
                                                    ...
                                                    <select class="form-control input-border-bottom" id="cos_aloca"
                                                        ...
                                                        <option value="Yes" @if($hr->cos_aloca=='Yes') selected
                                                            @endif>Yes</option>
                                                        <option value="No" @if($hr->cos_aloca=='No') selected @endif>No
                                                        </option>
