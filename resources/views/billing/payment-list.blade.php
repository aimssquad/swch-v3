			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Payment Received</h4>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Payment Received <span><a href="{{ url('billing/add-received-payment') }}"> Received Payment</a></span></h4>
												...
												<tr>
													<th>Sl.No.</th>
														<th>Invoice Number</th>
														 <th>Bank Payment Reference Id.</th>
				...
				->first(); 
						...
						<tr>
							...
							<td>{{ $company->in_id }}</td>
								<td>{{ $company->bank_payment_id }}</td>
									<td>{{ $company->pay_recipt }}</td>
							<td>{{ $pass->com_name }}</td>
							...
							<td>{{ strtoupper($company->status) }}</td>
                            	...
                            	<td> @if($company->pay_recipt_pdf!='')  
                                          <a href="{{asset('public/paypdf/'.$company->pay_recipt_pdf)}}" download><i class="fas fa-download"></i></a>  @endif</td>     
						</tr>
