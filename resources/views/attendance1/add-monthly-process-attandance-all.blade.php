         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card custom-card">
                  ...
                  @endif
                  <div class="card-body">
                     <form  method="post" action="{{url('attendance/add-montly-attendance-data-all')}}" enctype="multipart/form-data" >
         ...
         @if($result !='')
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('attendance/save-montly-attendance-data-all') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
