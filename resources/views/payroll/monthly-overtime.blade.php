...
<div class="main-panel">
   <div class="page-header">
      ...
      <ul class="breadcrumbs">
         ...
         <li class="separator"> / </li>
         <li class="nav-item active"><a href="#">Generate Monthly Overtimes</a></li>
      </ul>
   </div>
   <div class="content">
            ...
            <div class="col-md-12">
               <div class="card custom-card">
                <div class="card-header d-flex justify-content-end">
                    <a href="{{url('payroll/add-montly-overtimes')}}" class="btn btn-outline-primary mb-3">Generate Monthly Overtimes <i class="fa fa-plus"></i></a>
                </div>
