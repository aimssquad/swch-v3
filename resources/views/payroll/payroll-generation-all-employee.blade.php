                    ...
                    <div class="col-md-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-end">
                                <a href="{{ url('payroll/add-generate-payroll-all') }}"
                                    class="btn btn-outline-primary mb-3">Generate All Employee Payroll <i class="fa fa-plus"></i></a>
                            </div>
                            @include('layout.message')
                            <div class="card-body">
                                <form action="{{ url('payroll/vw-payroll-generation-all-employee') }}" method="post"
