   ...
   <div class="page-header page-header-fixed">
      ...
      <ul class="breadcrumbs">
        <li class="nav-home"><a href="{{url('payroll-home-dashboard')}}"> Home</a></li>
         ...
         <li class="separator">/</li>
         <li class="nav-item active"><a href="#">Salary Adjustment (Payroll)</a></li>
      </ul>
   </div>
   <div class="content">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><i class="fa fa-cog" aria-hidden="true" style="color:#10277f;"></i>&nbsp;Salary Adjustment (Payroll)</h4>
                        <div class="card-header-fixed-loan">
                        <a href="{{url('payroll/adjustment-payroll-generation')}}" class="btn btn-outline-primary mb-3" style="color: black">Generate Salary Adjustment (Payroll) <i class="fa fa-plus"></i></a>
                    </div>
