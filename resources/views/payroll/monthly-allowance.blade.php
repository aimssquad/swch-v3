...
<div class="main-panel">
   <div class="page-header">
      ...
      <ul class="breadcrumbs">
         ...
         <li class="separator"> / </li>
         <li class="nav-item active"><a href="#">Generate Monthly Allowances</a></li>
      </ul>
   </div>
   <div class="content">
            ...
            <div class="col-md-12">
               <div class="card custom-card">
                <div class="card-header d-flex justify-content-end">
                    <a href="{{url('payroll/add-montly-allowances')}}" class="btn btn-outline-primary mb-3">Generate Monthly Allowances <i class="fa fa-plus"></i></a>
                </div>
								...
								<table id="basic-datatables" class="table table-striped table-bordered table-responsive">
									...
									<tfoot>
										<tr>
											...
											<div class="row">
												<div class="col-md-5">
													<button type="button" class="btn btn-info btn-sm checkall" style="margin-right:2%;font-size:11.5px;">Check All</button>
													<button type="submit" class="btn btn-primary btn-sm" style="font-size:11.5px;" onclick="map_controls();">Save</button>
													<button type="reset" class="btn btn-warning btn-sm" style="font-size:11.5px;"> Reset</button>
												...
												<div class="col-md-4">
													<button type="submit" name="btnDelete" class="btn btn-info btn-sm" style="background-color:red !important;float:right;font-size:11px;" onclick="confirmDelete(event);">Delete All Records for the month</button>
												</div>
											</div>
