						...
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header">
									<h4 class="card-title">Organisation 
										<span>		<a href="{{url('company/company-report/'.base64_encode($companies_rs->reg))}}">Download Report</a></span></h4>
					...
					@endif
						...
						<tr>
                            ...
                            <td>{{ $companies_rs->p_no }}</td>
                             ...
                             <td>
                  <a href="{{url('company-profile/edit-company')}}?c_id={{base64_encode($companies_rs->id)}}"><img  style="width: 30px;" src="{{ asset('assets/img/edit.png')}}"></a> 
